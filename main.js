...
`)+`
`+f);let A=b+m+a,_=b+f+o,M=Bf(s,s.VERTEX_SHADER,A),S=Bf(s,s.FRAGMENT_SHADER,_);s.attachShader(x,M),s.attachShader(x,S),e.index0AttributeName!==void 0?s.bindAttribLocation(x,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(x,0,"position"),s.linkProgram(x);function w(P){if(n.debug.checkShaderErrors){let N=s.getProgramInfoLog(x)||"",H=s.getShaderInfoLog(M)||"",R=s.getShaderInfoLog(S)||"",D=N.trim(),U=H.trim(),L=R.trim(),O=!0,q=!0;if(s.getProgramParameter(x,s.LINK_STATUS)===!1)if(O=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,x,M,S);else{let $=kf(s,M,"vertex"),nt=kf(s,S,"fragment");Bt("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(x,s.VALIDATE_STATUS)+`
...
}`,Bv=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],zv=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],Zf=new fe,Lr=new V,lh=new V;function kv(n,t,e){let i=new hr,s=new Ot,r=new Ot,a=new de,o=new Qa,l=new to,c={},h=e.maxTextureSize,d={[Kn]:Ge,[Ge]:Kn,[On]:On},u=new rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ot},radius:{value:4}},vertexShader:Fv,fragmentShader:Ov}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let g=new Ve;g.setAttribute("position",new Xe(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let x=new Ye(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Mr;let f=this.type;this.render=function(S,w,y){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;this.type===Gu&&(Ft("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Mr);let E=n.getRenderTarget(),I=n.getActiveCubeFace(),P=n.getActiveMipmapLevel(),N=n.state;N.setBlending(Bn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);let H=f!==this.type;H&&w.traverse(function(R){R.material&&(Array.isArray(R.material)?R.material.forEach(D=>D.needsUpdate=!0):R.material.needsUpdate=!0)});for(let R=0,D=S.length;R<D;R++){let U=S[R],L=U.shadow;if(L===void 0){Ft("WebGLShadowMap:",U,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);let O=L.getFrameExtents();s.multiply(O),r.copy(L.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/O.x),s.x=r.x*O.x,L.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/O.y),s.y=r.y*O.y,L.mapSize.y=r.y));let q=n.state.buffers.depth.getReversed();if(L.camera._reversedDepth=q,L.map===null||H===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Cs){if(U.isPointLight){Ft("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new sn(s.x,s.y,{format:Ti,type:zn,minFilter:Ie,magFilter:Ie,generateMipmaps:!1}),L.map.texture.name=U.name+".shadowMap",L.map.depthTexture=new Qn(s.x,s.y,wn),L.map.depthTexture.name=U.name+".shadowMapDepth",L.map.depthTexture.format=Fn,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Ce,L.map.depthTexture.magFilter=Ce}else U.isPointLight?(L.map=new al(s.x),L.map.depthTexture=new Ka(s.x,Sn)):(L.map=new sn(s.x,s.y),L.map.depthTexture=new Qn(s.x,s.y,Sn)),L.map.depthTexture.name=U.name+".shadowMap",L.map.depthTexture.format=Fn,this.type===Mr?(L.map.depthTexture.compareFunction=q?nl:el,L.map.depthTexture.minFilter=Ie,L.map.depthTexture.magFilter=Ie):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Ce,L.map.depthTexture.magFilter=Ce);L.camera.updateProjectionMatrix()}let $=L.map.isWebGLCubeRenderTarget?6:1;for(let nt=0;nt<$;nt++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,nt),n.clear();else{nt===0&&(n.setRenderTarget(L.map),n.clear());let G=L.getViewport(nt);a.set(r.x*G.x,r.y*G.y,r.x*G.z,r.y*G.w),N.viewport(a)}if(U.isPointLight){let G=L.camera,ot=L.matrix,mt=U.distance||G.far;mt!==G.far&&(G.far=mt,G.updateProjectionMatrix()),Lr.setFromMatrixPosition(U.matrixWorld),G.position.copy(Lr),lh.copy(G.position),lh.add(Bv[nt]),G.up.copy(zv[nt]),G.lookAt(lh),G.updateMatrixWorld(),ot.makeTranslation(-Lr.x,-Lr.y,-Lr.z),Zf.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),L._frustum.setFromProjectionMatrix(Zf,G.coordinateSystem,G.reversedDepth)}else L.updateMatrices(U);i=L.getFrustum(),_(w,y,L.camera,U,this.type)}L.isPointLightShadow!==!0&&this.type===Cs&&b(L,y),L.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(E,I,P)};function b(S,w){let y=t.update(x);u.defines.VSM_SAMPLES!==S.blurSamples&&(u.defines.VSM_SAMPLES=S.blurSamples,p.defines.VSM_SAMPLES=S.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new sn(s.x,s.y,{format:Ti,type:zn})),u.uniforms.shadow_pass.value=S.map.depthTexture,u.uniforms.resolution.value=S.mapSize,u.uniforms.radius.value=S.radius,n.setRenderTarget(S.mapPass),n.clear(),n.renderBufferDirect(w,null,y,u,x,null),p.uniforms.shadow_pass.value=S.mapPass.texture,p.uniforms.resolution.value=S.mapSize,p.uniforms.radius.value=S.radius,n.setRenderTarget(S.map),n.clear(),n.renderBufferDirect(w,null,y,p,x,null)}function A(S,w,y,E){let I=null,P=y.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(P!==void 0)I=P;else if(I=y.isPointLight===!0?l:o,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let N=I.uuid,H=w.uuid,R=c[N];R===void 0&&(R={},c[N]=R);let D=R[H];D===void 0&&(D=I.clone(),R[H]=D,w.addEventListener("dispose",M)),I=D}if(I.visible=w.visible,I.wireframe=w.wireframe,E===Cs?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:d[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,y.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let N=n.properties.get(I);N.light=y}return I}function _(S,w,y,E,I){if(S.visible===!1)return;if(S.layers.test(w.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&I===Cs)&&(!S.frustumCulled||i.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(y.matrixWorldInverse,S.matrixWorld);let H=t.update(S),R=S.material;if(Array.isArray(R)){let D=H.groups;for(let U=0,L=D.length;U<L;U++){let O=D[U],q=R[O.materialIndex];if(q&&q.visible){let $=A(S,q,E,I);S.onBeforeShadow(n,S,w,y,H,$,O),n.renderBufferDirect(y,null,H,$,S,O),S.onAfterShadow(n,S,w,y,H,$,O)}}}else if(R.visible){let D=A(S,R,E,I);S.onBeforeShadow(n,S,w,y,H,D,null),n.renderBufferDirect(y,null,H,D,S,null),S.onAfterShadow(n,S,w,y,H,D,null)}}let N=S.children;for(let H=0,R=N.length;H<R;H++)_(N[H],w,y,E,I)}function M(S){S.target.removeEventListener("dispose",M);for(let y in c){let E=c[y],I=S.target.uuid;I in E&&(E[I].dispose(),delete E[I])}}}function Vv(n,t){function e(){let B=!1,ht=new de,tt=null,pt=new de(0,0,0,0);return{setMask:function(bt){tt!==bt&&!B&&(n.colorMask(bt,bt,bt,bt),tt=bt)},setLocked:function(bt){B=bt},setClear:function(bt,st,Rt,Tt,pe){pe===!0&&(bt*=Tt,st*=Tt,Rt*=Tt),ht.set(bt,st,Rt,Tt),pt.equals(ht)===!1&&(n.clearColor(bt,st,Rt,Tt),pt.copy(ht))},reset:function(){B=!1,tt=null,pt.set(-1,0,0,0)}}}function i(){let B=!1,ht=!1,tt=null,pt=null,bt=null;return{setReversed:function(st){if(ht!==st){let Rt=t.get("EXT_clip_control");st?Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.ZERO_TO_ONE_EXT):Rt.clipControlEXT(Rt.LOWER_LEFT_EXT,Rt.NEGATIVE_ONE_TO_ONE_EXT),ht=st;let Tt=bt;bt=null,this.setClear(Tt)}},getReversed:function(){return ht},setTest:function(st){st?et(n.DEPTH_TEST):It(n.DEPTH_TEST)},setMask:function(st){tt!==st&&!B&&(n.depthMask(st),tt=st)},setFunc:function(st){if(ht&&(st=Mf[st]),pt!==st){switch(st){case La:n.depthFunc(n.NEVER);break;case Da:n.depthFunc(n.ALWAYS);break;case Na:n.depthFunc(n.LESS);break;case Gi:n.depthFunc(n.LEQUAL);break;case Ua:n.depthFunc(n.EQUAL);break;case Fa:n.depthFunc(n.GEQUAL);break;case Oa:n.depthFunc(n.GREATER);break;case Ba:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pt=st}},setLocked:function(st){B=st},setClear:function(st){bt!==st&&(bt=st,ht&&(st=1-st),n.clearDepth(st))},reset:function(){B=!1,tt=null,pt=null,bt=null,ht=!1}}}function s(){let B=!1,ht=null,tt=null,pt=null,bt=null,st=null,Rt=null,Tt=null,pe=null;return{setTest:function(ce){B||(ce?et(n.STENCIL_TEST):It(n.STENCIL_TEST))},setMask:function(ce){ht!==ce&&!B&&(n.stencilMask(ce),ht=ce)},setFunc:function(ce,Pn,Ln){(tt!==ce||pt!==Pn||bt!==Ln)&&(n.stencilFunc(ce,Pn,Ln),tt=ce,pt=Pn,bt=Ln)},setOp:function(ce,Pn,Ln){(st!==ce||Rt!==Pn||Tt!==Ln)&&(n.stencilOp(ce,Pn,Ln),st=ce,Rt=Pn,Tt=Ln)},setLocked:function(ce){B=ce},setClear:function(ce){pe!==ce&&(n.clearStencil(ce),pe=ce)},reset:function(){B=!1,ht=null,tt=null,pt=null,bt=null,st=null,Rt=null,Tt=null,pe=null}}}let r=new e,a=new i,o=new s,l=new WeakMap,c=new WeakMap,h={},d={},u={},p=new WeakMap,g=[],x=null,m=!1,f=null,b=null,A=null,_=null,M=null,S=null,w=null,y=new $t(0,0,0),E=0,I=!1,P=null,N=null,H=null,R=null,D=null,U=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),L=!1,O=0,q=n.getParameter(n.VERSION);q.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(q)[1]),L=O>=1):q.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(q)[1]),L=O>=2);let $=null,nt={},G=n.getParameter(n.SCISSOR_BOX),ot=n.getParameter(n.VIEWPORT),mt=new de().fromArray(G),yt=new de().fromArray(ot);function Z(B,ht,tt,pt){let bt=new Uint8Array(4),st=n.createTexture();n.bindTexture(B,st),n.texParameteri(B,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(B,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let Rt=0;Rt<tt;Rt++)B===n.TEXTURE_3D||B===n.TEXTURE_2D_ARRAY?n.texImage3D(ht,0,n.RGBA,1,1,pt,0,n.RGBA,n.UNSIGNED_BYTE,bt):n.texImage2D(ht+Rt,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,bt);return st}let it={};it[n.TEXTURE_2D]=Z(n.TEXTURE_2D,n.TEXTURE_2D,1),it[n.TEXTURE_CUBE_MAP]=Z(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[n.TEXTURE_2D_ARRAY]=Z(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),it[n.TEXTURE_3D]=Z(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),et(n.DEPTH_TEST),a.setFunc(Gi),te(!1),ye(wc),et(n.CULL_FACE),kt(Bn);function et(B){h[B]!==!0&&(n.enable(B),h[B]=!0)}function It(B){h[B]!==!1&&(n.disable(B),h[B]=!1)}function Pt(B,ht){return u[B]!==ht?(n.bindFramebuffer(B,ht),u[B]=ht,B===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=ht),B===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=ht),!0):!1}function wt(B,ht){let tt=g,pt=!1;if(B){tt=p.get(ht),tt===void 0&&(tt=[],p.set(ht,tt));let bt=B.textures;if(tt.length!==bt.length||tt[0]!==n.COLOR_ATTACHMENT0){for(let st=0,Rt=bt.length;st<Rt;st++)tt[st]=n.COLOR_ATTACHMENT0+st;tt.length=bt.length,pt=!0}}else tt[0]!==n.BACK&&(tt[0]=n.BACK,pt=!0);pt&&n.drawBuffers(tt)}function Qt(B){return x!==B?(n.useProgram(B),x=B,!0):!1}let ut={[pi]:n.FUNC_ADD,[Wu]:n.FUNC_SUBTRACT,[Xu]:n.FUNC_REVERSE_SUBTRACT};ut[qu]=n.MIN,ut[Yu]=n.MAX;let Ct={[Zu]:n.ZERO,[$u]:n.ONE,[Ju]:n.SRC_COLOR,[Ia]:n.SRC_ALPHA,[nf]:n.SRC_ALPHA_SATURATE,[tf]:n.DST_COLOR,[ju]:n.DST_ALPHA,[Ku]:n.ONE_MINUS_SRC_COLOR,[Pa]:n.ONE_MINUS_SRC_ALPHA,[ef]:n.ONE_MINUS_DST_COLOR,[Qu]:n.ONE_MINUS_DST_ALPHA,[sf]:n.CONSTANT_COLOR,[rf]:n.ONE_MINUS_CONSTANT_COLOR,[af]:n.CONSTANT_ALPHA,[of]:n.ONE_MINUS_CONSTANT_ALPHA};function kt(B,ht,tt,pt,bt,st,Rt,Tt,pe,ce){if(B===Bn){m===!0&&(It(n.BLEND),m=!1);return}if(m===!1&&(et(n.BLEND),m=!0),B!==Hu){if(B!==f||ce!==I){if((b!==pi||M!==pi)&&(n.blendEquation(n.FUNC_ADD),b=pi,M=pi),ce)switch(B){case Vi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ec:n.blendFunc(n.ONE,n.ONE);break;case Tc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Ac:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Bt("WebGLState: Invalid blending: ",B);break}else switch(B){case Vi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Ec:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Tc:Bt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Ac:Bt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Bt("WebGLState: Invalid blending: ",B);break}A=null,_=null,S=null,w=null,y.set(0,0,0),E=0,f=B,I=ce}return}bt=bt||ht,st=st||tt,Rt=Rt||pt,(ht!==b||bt!==M)&&(n.blendEquationSeparate(ut[ht],ut[bt]),b=ht,M=bt),(tt!==A||pt!==_||st!==S||Rt!==w)&&(n.blendFuncSeparate(Ct[tt],Ct[pt],Ct[st],Ct[Rt]),A=tt,_=pt,S=st,w=Rt),(Tt.equals(y)===!1||pe!==E)&&(n.blendColor(Tt.r,Tt.g,Tt.b,pe),y.copy(Tt),E=pe),f=B,I=!1}function Zt(B,ht){B.side===On?It(n.CULL_FACE):et(n.CULL_FACE);let tt=B.side===Ge;ht&&(tt=!tt),te(tt),B.blending===Vi&&B.transparent===!1?kt(Bn):kt(B.blending,B.blendEquation,B.blendSrc,B.blendDst,B.blendEquationAlpha,B.blendSrcAlpha,B.blendDstAlpha,B.blendColor,B.blendAlpha,B.premultipliedAlpha),a.setFunc(B.depthFunc),a.setTest(B.depthTest),a.setMask(B.depthWrite),r.setMask(B.colorWrite);let pt=B.stencilWrite;o.setTest(pt),pt&&(o.setMask(B.stencilWriteMask),o.setFunc(B.stencilFunc,B.stencilRef,B.stencilFuncMask),o.setOp(B.stencilFail,B.stencilZFail,B.stencilZPass)),lt(B.polygonOffset,B.polygonOffsetFactor,B.polygonOffsetUnits),B.alphaToCoverage===!0?et(n.SAMPLE_ALPHA_TO_COVERAGE):It(n.SAMPLE_ALPHA_TO_COVERAGE)}function te(B){P!==B&&(B?n.frontFace(n.CW):n.frontFace(n.CCW),P=B)}function ye(B){B!==ku?(et(n.CULL_FACE),B!==N&&(B===wc?n.cullFace(n.BACK):B===Vu?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):It(n.CULL_FACE),N=B}function at(B){B!==H&&(L&&n.lineWidth(B),H=B)}function lt(B,ht,tt){B?(et(n.POLYGON_OFFSET_FILL),(R!==ht||D!==tt)&&(R=ht,D=tt,a.getReversed()&&(ht=-ht),n.polygonOffset(ht,tt))):It(n.POLYGON_OFFSET_FILL)}function Et(B){B?et(n.SCISSOR_TEST):It(n.SCISSOR_TEST)}function Kt(B){B===void 0&&(B=n.TEXTURE0+U-1),$!==B&&(n.activeTexture(B),$=B)}function F(B,ht,tt){tt===void 0&&($===null?tt=n.TEXTURE0+U-1:tt=$);let pt=nt[tt];pt===void 0&&(pt={type:void 0,texture:void 0},nt[tt]=pt),(pt.type!==B||pt.texture!==ht)&&($!==tt&&(n.activeTexture(tt),$=tt),n.bindTexture(B,ht||it[B]),pt.type=B,pt.texture=ht)}function ae(){let B=nt[$];B!==void 0&&B.type!==void 0&&(n.bindTexture(B.type,null),B.type=void 0,B.texture=void 0)}function Gt(){try{n.compressedTexImage2D(...arguments)}catch(B){Bt("WebGLState:",B)}}function C(){try{n.compressedTexImage3D(...arguments)}catch(B){Bt("WebGLState:",B)}}function v(){try{n.texSubImage2D(...arguments)}catch(B){Bt("WebGLState:",B)}}function k(){try{n.texSubImage3D(...arguments)}catch(B){Bt("WebGLState:",B)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(B){Bt("WebGLState:",B)}}function K(){try{n.compressedTexSubImage3D(...arguments)}catch(B){Bt("WebGLState:",B)}}function rt(){try{n.texStorage2D(...arguments)}catch(B){Bt("WebGLState:",B)}}function ct(){try{n.texStorage3D(...arguments)}catch(B){Bt("WebGLState:",B)}}function j(){try{n.texImage2D(...arguments)}catch(B){Bt("WebGLState:",B)}}function Q(){try{n.texImage3D(...arguments)}catch(B){Bt("WebGLState:",B)}}function ft(B){return d[B]!==void 0?d[B]:n.getParameter(B)}function Lt(B,ht){d[B]!==ht&&(n.pixelStorei(B,ht),d[B]=ht)}function gt(B){mt.equals(B)===!1&&(n.scissor(B.x,B.y,B.z,B.w),mt.copy(B))}function dt(B){yt.equals(B)===!1&&(n.viewport(B.x,B.y,B.z,B.w),yt.copy(B))}function Ut(B,ht){let tt=c.get(ht);tt===void 0&&(tt=new WeakMap,c.set(ht,tt));let pt=tt.get(B);pt===void 0&&(pt=n.getUniformBlockIndex(ht,B.name),tt.set(B,pt))}function zt(B,ht){let pt=c.get(ht).get(B);l.get(ht)!==pt&&(n.uniformBlockBinding(ht,pt,B.__bindingPointIndex),l.set(ht,pt))}function Ht(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),h={},d={},$=null,nt={},u={},p=new WeakMap,g=[],x=null,m=!1,f=null,b=null,A=null,_=null,M=null,S=null,w=null,y=new $t(0,0,0),E=0,I=!1,P=null,N=null,H=null,R=null,D=null,mt.set(0,0,n.canvas.width,n.canvas.height),yt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:et,disable:It,bindFramebuffer:Pt,drawBuffers:wt,useProgram:Qt,setBlending:kt,setMaterial:Zt,setFlipSided:te,setCullFace:ye,setLineWidth:at,setPolygonOffset:lt,setScissorTest:Et,activeTexture:Kt,bindTexture:F,unbindTexture:ae,compressedTexImage2D:Gt,compressedTexImage3D:C,texImage2D:j,texImage3D:Q,pixelStorei:Lt,getParameter:ft,updateUBOMapping:Ut,uniformBlockBinding:zt,texStorage2D:rt,texStorage3D:ct,texSubImage2D:v,texSubImage3D:k,compressedTexSubImage2D:W,compressedTexSubImage3D:K,scissor:gt,viewport:dt,reset:Ht}}function Gv(n,t,e,i,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Ot,h=new WeakMap,d=new Set,u,p=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch(C){}function x(C,v){return g?new OffscreenCanvas(C,v):nr("canvas")}function m(C,v,k){let W=1,K=Gt(C);if((K.width>k||K.height>k)&&(W=k/Math.max(K.width,K.height)),W<1)if(typeof HTMLImageElement!="undefined"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&C instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&C instanceof ImageBitmap||typeof VideoFrame!="undefined"&&C instanceof VideoFrame){let rt=Math.floor(W*K.width),ct=Math.floor(W*K.height);u===void 0&&(u=x(rt,ct));let j=v?x(rt,ct):u;return j.width=rt,j.height=ct,j.getContext("2d").drawImage(C,0,0,rt,ct),Ft("WebGLRenderer: Texture has been resized from ("+K.width+"x"+K.height+") to ("+rt+"x"+ct+")."),j}else return"data"in C&&Ft("WebGLRenderer: Image in DataTexture is too big ("+K.width+"x"+K.height+")."),C;return C}function f(C){return C.generateMipmaps}function b(C){n.generateMipmap(C)}function A(C){return C.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?n.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(C,v,k,W,K,rt=!1){if(C!==null){if(n[C]!==void 0)return n[C];Ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ct;W&&(ct=t.get("EXT_texture_norm16"),ct||Ft("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let j=v;if(v===n.RED&&(k===n.FLOAT&&(j=n.R32F),k===n.HALF_FLOAT&&(j=n.R16F),k===n.UNSIGNED_BYTE&&(j=n.R8),k===n.UNSIGNED_SHORT&&ct&&(j=ct.R16_EXT),k===n.SHORT&&ct&&(j=ct.R16_SNORM_EXT)),v===n.RED_INTEGER&&(k===n.UNSIGNED_BYTE&&(j=n.R8UI),k===n.UNSIGNED_SHORT&&(j=n.R16UI),k===n.UNSIGNED_INT&&(j=n.R32UI),k===n.BYTE&&(j=n.R8I),k===n.SHORT&&(j=n.R16I),k===n.INT&&(j=n.R32I)),v===n.RG&&(k===n.FLOAT&&(j=n.RG32F),k===n.HALF_FLOAT&&(j=n.RG16F),k===n.UNSIGNED_BYTE&&(j=n.RG8),k===n.UNSIGNED_SHORT&&ct&&(j=ct.RG16_EXT),k===n.SHORT&&ct&&(j=ct.RG16_SNORM_EXT)),v===n.RG_INTEGER&&(k===n.UNSIGNED_BYTE&&(j=n.RG8UI),k===n.UNSIGNED_SHORT&&(j=n.RG16UI),k===n.UNSIGNED_INT&&(j=n.RG32UI),k===n.BYTE&&(j=n.RG8I),k===n.SHORT&&(j=n.RG16I),k===n.INT&&(j=n.RG32I)),v===n.RGB_INTEGER&&(k===n.UNSIGNED_BYTE&&(j=n.RGB8UI),k===n.UNSIGNED_SHORT&&(j=n.RGB16UI),k===n.UNSIGNED_INT&&(j=n.RGB32UI),k===n.BYTE&&(j=n.RGB8I),k===n.SHORT&&(j=n.RGB16I),k===n.INT&&(j=n.RGB32I)),v===n.RGBA_INTEGER&&(k===n.UNSIGNED_BYTE&&(j=n.RGBA8UI),k===n.UNSIGNED_SHORT&&(j=n.RGBA16UI),k===n.UNSIGNED_INT&&(j=n.RGBA32UI),k===n.BYTE&&(j=n.RGBA8I),k===n.SHORT&&(j=n.RGBA16I),k===n.INT&&(j=n.RGBA32I)),v===n.RGB&&(k===n.UNSIGNED_SHORT&&ct&&(j=ct.RGB16_EXT),k===n.SHORT&&ct&&(j=ct.RGB16_SNORM_EXT),k===n.UNSIGNED_INT_5_9_9_9_REV&&(j=n.RGB9_E5),k===n.UNSIGNED_INT_10F_11F_11F_REV&&(j=n.R11F_G11F_B10F)),v===n.RGBA){let Q=rt?tr:Jt.getTransfer(K);k===n.FLOAT&&(j=n.RGBA32F),k===n.HALF_FLOAT&&(j=n.RGBA16F),k===n.UNSIGNED_BYTE&&(j=Q===ee?n.SRGB8_ALPHA8:n.RGBA8),k===n.UNSIGNED_SHORT&&ct&&(j=ct.RGBA16_EXT),k===n.SHORT&&ct&&(j=ct.RGBA16_SNORM_EXT),k===n.UNSIGNED_SHORT_4_4_4_4&&(j=n.RGBA4),k===n.UNSIGNED_SHORT_5_5_5_1&&(j=n.RGB5_A1)}return(j===n.R16F||j===n.R32F||j===n.RG16F||j===n.RG32F||j===n.RGBA16F||j===n.RGBA32F)&&t.get("EXT_color_buffer_float"),j}function M(C,v){let k;return C?v===null||v===Sn||v===Is?k=n.DEPTH24_STENCIL8:v===wn?k=n.DEPTH32F_STENCIL8:v===Rs&&(k=n.DEPTH24_STENCIL8,Ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Sn||v===Is?k=n.DEPTH_COMPONENT24:v===wn?k=n.DEPTH_COMPONENT32F:v===Rs&&(k=n.DEPTH_COMPONENT16),k}function S(C,v){return f(C)===!0||C.isFramebufferTexture&&C.minFilter!==Ce&&C.minFilter!==Ie?Math.log2(Math.max(v.width,v.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?v.mipmaps.length:1}function w(C){let v=C.target;v.removeEventListener("dispose",w),E(v),v.isVideoTexture&&h.delete(v),v.isHTMLTexture&&d.delete(v)}function y(C){let v=C.target;v.removeEventListener("dispose",y),P(v)}function E(C){let v=i.get(C);if(v.__webglInit===void 0)return;let k=C.source,W=p.get(k);if(W){let K=W[v.__cacheKey];K.usedTimes--,K.usedTimes===0&&I(C),Object.keys(W).length===0&&p.delete(k)}i.remove(C)}function I(C){let v=i.get(C);n.deleteTexture(v.__webglTexture);let k=C.source,W=p.get(k);delete W[v.__cacheKey],a.memory.textures--}function P(C){let v=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(v.__webglFramebuffer[W]))for(let K=0;K<v.__webglFramebuffer[W].length;K++)n.deleteFramebuffer(v.__webglFramebuffer[W][K]);else n.deleteFramebuffer(v.__webglFramebuffer[W]);v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer[W])}else{if(Array.isArray(v.__webglFramebuffer))for(let W=0;W<v.__webglFramebuffer.length;W++)n.deleteFramebuffer(v.__webglFramebuffer[W]);else n.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&n.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&n.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let W=0;W<v.__webglColorRenderbuffer.length;W++)v.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(v.__webglColorRenderbuffer[W]);v.__webglDepthRenderbuffer&&n.deleteRenderbuffer(v.__webglDepthRenderbuffer)}let k=C.textures;for(let W=0,K=k.length;W<K;W++){let rt=i.get(k[W]);rt.__webglTexture&&(n.deleteTexture(rt.__webglTexture),a.memory.textures--),i.remove(k[W])}i.remove(C)}let N=0;function H(){N=0}function R(){return N}function D(C){N=C}function U(){let C=N;return C>=s.maxTextures&&Ft("WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),N+=1,C}function L(C){let v=[];return v.push(C.wrapS),v.push(C.wrapT),v.push(C.wrapR||0),v.push(C.magFilter),v.push(C.minFilter),v.push(C.anisotropy),v.push(C.internalFormat),v.push(C.format),v.push(C.type),v.push(C.generateMipmaps),v.push(C.premultiplyAlpha),v.push(C.flipY),v.push(C.unpackAlignment),v.push(C.colorSpace),v.join()}function O(C,v){let k=i.get(C);if(C.isVideoTexture&&F(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&k.__version!==C.version){let W=C.image;if(W===null)Ft("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ft("WebGLRenderer: Texture marked for update but image is incomplete");else{It(k,C,v);return}}else C.isExternalTexture&&(k.__webglTexture=C.sourceTexture?C.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,k.__webglTexture,n.TEXTURE0+v)}function q(C,v){let k=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&k.__version!==C.version){It(k,C,v);return}else C.isExternalTexture&&(k.__webglTexture=C.sourceTexture?C.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,k.__webglTexture,n.TEXTURE0+v)}function $(C,v){let k=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&k.__version!==C.version){It(k,C,v);return}e.bindTexture(n.TEXTURE_3D,k.__webglTexture,n.TEXTURE0+v)}function nt(C,v){let k=i.get(C);if(C.isCubeDepthTexture!==!0&&C.version>0&&k.__version!==C.version){Pt(k,C,v);return}e.bindTexture(n.TEXTURE_CUBE_MAP,k.__webglTexture,n.TEXTURE0+v)}let G={[za]:n.REPEAT,[Un]:n.CLAMP_TO_EDGE,[ka]:n.MIRRORED_REPEAT},ot={[Ce]:n.NEAREST,[hf]:n.NEAREST_MIPMAP_NEAREST,[wr]:n.NEAREST_MIPMAP_LINEAR,[Ie]:n.LINEAR,[xo]:n.LINEAR_MIPMAP_NEAREST,[wi]:n.LINEAR_MIPMAP_LINEAR},mt={[df]:n.NEVER,[xf]:n.ALWAYS,[pf]:n.LESS,[el]:n.LEQUAL,[mf]:n.EQUAL,[nl]:n.GEQUAL,[gf]:n.GREATER,[_f]:n.NOTEQUAL};function yt(C,v){if(v.type===wn&&t.has("OES_texture_float_linear")===!1&&(v.magFilter===Ie||v.magFilter===xo||v.magFilter===wr||v.magFilter===wi||v.minFilter===Ie||v.minFilter===xo||v.minFilter===wr||v.minFilter===wi)&&Ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(C,n.TEXTURE_WRAP_S,G[v.wrapS]),n.texParameteri(C,n.TEXTURE_WRAP_T,G[v.wrapT]),(C===n.TEXTURE_3D||C===n.TEXTURE_2D_ARRAY)&&n.texParameteri(C,n.TEXTURE_WRAP_R,G[v.wrapR]),n.texParameteri(C,n.TEXTURE_MAG_FILTER,ot[v.magFilter]),n.texParameteri(C,n.TEXTURE_MIN_FILTER,ot[v.minFilter]),v.compareFunction&&(n.texParameteri(C,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(C,n.TEXTURE_COMPARE_FUNC,mt[v.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Ce||v.minFilter!==wr&&v.minFilter!==wi||v.type===wn&&t.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){let k=t.get("EXT_texture_filter_anisotropic");n.texParameterf(C,k.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,s.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Z(C,v){let k=!1;C.__webglInit===void 0&&(C.__webglInit=!0,v.addEventListener("dispose",w));let W=v.source,K=p.get(W);K===void 0&&(K={},p.set(W,K));let rt=L(v);if(rt!==C.__cacheKey){K[rt]===void 0&&(K[rt]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,k=!0),K[rt].usedTimes++;let ct=K[C.__cacheKey];ct!==void 0&&(K[C.__cacheKey].usedTimes--,ct.usedTimes===0&&I(v)),C.__cacheKey=rt,C.__webglTexture=K[rt].texture}return k}function it(C,v,k){return Math.floor(Math.floor(C/k)/v)}function et(C,v,k,W){let rt=C.updateRanges;if(rt.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,v.width,v.height,k,W,v.data);else{rt.sort((Lt,gt)=>Lt.start-gt.start);let ct=0;for(let Lt=1;Lt<rt.length;Lt++){let gt=rt[ct],dt=rt[Lt],Ut=gt.start+gt.count,zt=it(dt.start,v.width,4),Ht=it(gt.start,v.width,4);dt.start<=Ut+1&&zt===Ht&&it(dt.start+dt.count-1,v.width,4)===zt?gt.count=Math.max(gt.count,dt.start+dt.count-gt.start):(++ct,rt[ct]=dt)}rt.length=ct+1;let j=e.getParameter(n.UNPACK_ROW_LENGTH),Q=e.getParameter(n.UNPACK_SKIP_PIXELS),ft=e.getParameter(n.UNPACK_SKIP_ROWS);e.pixelStorei(n.UNPACK_ROW_LENGTH,v.width);for(let Lt=0,gt=rt.length;Lt<gt;Lt++){let dt=rt[Lt],Ut=Math.floor(dt.start/4),zt=Math.ceil(dt.count/4),Ht=Ut%v.width,B=Math.floor(Ut/v.width),ht=zt,tt=1;e.pixelStorei(n.UNPACK_SKIP_PIXELS,Ht),e.pixelStorei(n.UNPACK_SKIP_ROWS,B),e.texSubImage2D(n.TEXTURE_2D,0,Ht,B,ht,tt,k,W,v.data)}C.clearUpdateRanges(),e.pixelStorei(n.UNPACK_ROW_LENGTH,j),e.pixelStorei(n.UNPACK_SKIP_PIXELS,Q),e.pixelStorei(n.UNPACK_SKIP_ROWS,ft)}}function It(C,v,k){let W=n.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),v.isData3DTexture&&(W=n.TEXTURE_3D);let K=Z(C,v),rt=v.source;e.bindTexture(W,C.__webglTexture,n.TEXTURE0+k);let ct=i.get(rt);if(rt.version!==ct.__version||K===!0){if(e.activeTexture(n.TEXTURE0+k),(typeof ImageBitmap!="undefined"&&v.image instanceof ImageBitmap)===!1){let tt=Jt.getPrimaries(Jt.workingColorSpace),pt=v.colorSpace===ti?null:Jt.getPrimaries(v.colorSpace),bt=v.colorSpace===ti||tt===pt?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,bt)}e.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment);let Q=m(v.image,!1,s.maxTextureSize);Q=ae(v,Q);let ft=r.convert(v.format,v.colorSpace),Lt=r.convert(v.type),gt=_(v.internalFormat,ft,Lt,v.normalized,v.colorSpace,v.isVideoTexture);yt(W,v);let dt,Ut=v.mipmaps,zt=v.isVideoTexture!==!0,Ht=ct.__version===void 0||K===!0,B=rt.dataReady,ht=S(v,Q);if(v.isDepthTexture)gt=M(v.format===Ei,v.type),Ht&&(zt?e.texStorage2D(n.TEXTURE_2D,1,gt,Q.width,Q.height):e.texImage2D(n.TEXTURE_2D,0,gt,Q.width,Q.height,0,ft,Lt,null));else if(v.isDataTexture)if(Ut.length>0){zt&&Ht&&e.texStorage2D(n.TEXTURE_2D,ht,gt,Ut[0].width,Ut[0].height);for(let tt=0,pt=Ut.length;tt<pt;tt++)dt=Ut[tt],zt?B&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,ft,Lt,dt.data):e.texImage2D(n.TEXTURE_2D,tt,gt,dt.width,dt.height,0,ft,Lt,dt.data);v.generateMipmaps=!1}else zt?(Ht&&e.texStorage2D(n.TEXTURE_2D,ht,gt,Q.width,Q.height),B&&et(v,Q,ft,Lt)):e.texImage2D(n.TEXTURE_2D,0,gt,Q.width,Q.height,0,ft,Lt,Q.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){zt&&Ht&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ht,gt,Ut[0].width,Ut[0].height,Q.depth);for(let tt=0,pt=Ut.length;tt<pt;tt++)if(dt=Ut[tt],v.format!==un)if(ft!==null)if(zt){if(B)if(v.layerUpdates.size>0){let bt=Kc(dt.width,dt.height,v.format,v.type);for(let st of v.layerUpdates){let Rt=dt.data.subarray(st*bt/dt.data.BYTES_PER_ELEMENT,(st+1)*bt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,st,dt.width,dt.height,1,ft,Rt)}v.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,0,dt.width,dt.height,Q.depth,ft,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,tt,gt,dt.width,dt.height,Q.depth,0,dt.data,0,0);else Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else zt?B&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,tt,0,0,0,dt.width,dt.height,Q.depth,ft,Lt,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,tt,gt,dt.width,dt.height,Q.depth,0,ft,Lt,dt.data)}else{zt&&Ht&&e.texStorage2D(n.TEXTURE_2D,ht,gt,Ut[0].width,Ut[0].height);for(let tt=0,pt=Ut.length;tt<pt;tt++)dt=Ut[tt],v.format!==un?ft!==null?zt?B&&e.compressedTexSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,ft,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,tt,gt,dt.width,dt.height,0,dt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):zt?B&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,dt.width,dt.height,ft,Lt,dt.data):e.texImage2D(n.TEXTURE_2D,tt,gt,dt.width,dt.height,0,ft,Lt,dt.data)}else if(v.isDataArrayTexture)if(zt){if(Ht&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ht,gt,Q.width,Q.height,Q.depth),B)if(v.layerUpdates.size>0){let tt=Kc(Q.width,Q.height,v.format,v.type);for(let pt of v.layerUpdates){let bt=Q.data.subarray(pt*tt/Q.data.BYTES_PER_ELEMENT,(pt+1)*tt/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,pt,Q.width,Q.height,1,ft,Lt,bt)}v.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ft,Lt,Q.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,gt,Q.width,Q.height,Q.depth,0,ft,Lt,Q.data);else if(v.isData3DTexture)zt?(Ht&&e.texStorage3D(n.TEXTURE_3D,ht,gt,Q.width,Q.height,Q.depth),B&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ft,Lt,Q.data)):e.texImage3D(n.TEXTURE_3D,0,gt,Q.width,Q.height,Q.depth,0,ft,Lt,Q.data);else if(v.isFramebufferTexture){if(Ht)if(zt)e.texStorage2D(n.TEXTURE_2D,ht,gt,Q.width,Q.height);else{let tt=Q.width,pt=Q.height;for(let bt=0;bt<ht;bt++)e.texImage2D(n.TEXTURE_2D,bt,gt,tt,pt,0,ft,Lt,null),tt>>=1,pt>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in n){let tt=n.canvas;if(tt.hasAttribute("layoutsubtree")||tt.setAttribute("layoutsubtree","true"),Q.parentNode!==tt){tt.appendChild(Q),d.add(v),tt.onpaint=pt=>{let bt=pt.changedElements;for(let st of d)bt.includes(st.image)&&(st.needsUpdate=!0)},tt.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,Q);else{let bt=n.RGBA,st=n.RGBA,Rt=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,bt,st,Rt,Q)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ut.length>0){if(zt&&Ht){let tt=Gt(Ut[0]);e.texStorage2D(n.TEXTURE_2D,ht,gt,tt.width,tt.height)}for(let tt=0,pt=Ut.length;tt<pt;tt++)dt=Ut[tt],zt?B&&e.texSubImage2D(n.TEXTURE_2D,tt,0,0,ft,Lt,dt):e.texImage2D(n.TEXTURE_2D,tt,gt,ft,Lt,dt);v.generateMipmaps=!1}else if(zt){if(Ht){let tt=Gt(Q);e.texStorage2D(n.TEXTURE_2D,ht,gt,tt.width,tt.height)}B&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ft,Lt,Q)}else e.texImage2D(n.TEXTURE_2D,0,gt,ft,Lt,Q);f(v)&&b(W),ct.__version=rt.version,v.onUpdate&&v.onUpdate(v)}C.__version=v.version}function Pt(C,v,k){if(v.image.length!==6)return;let W=Z(C,v),K=v.source;e.bindTexture(n.TEXTURE_CUBE_MAP,C.__webglTexture,n.TEXTURE0+k);let rt=i.get(K);if(K.version!==rt.__version||W===!0){e.activeTexture(n.TEXTURE0+k);let ct=Jt.getPrimaries(Jt.workingColorSpace),j=v.colorSpace===ti?null:Jt.getPrimaries(v.colorSpace),Q=v.colorSpace===ti||ct===j?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,v.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),e.pixelStorei(n.UNPACK_ALIGNMENT,v.unpackAlignment),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let ft=v.isCompressedTexture||v.image[0].isCompressedTexture,Lt=v.image[0]&&v.image[0].isDataTexture,gt=[];for(let st=0;st<6;st++)!ft&&!Lt?gt[st]=m(v.image[st],!0,s.maxCubemapSize):gt[st]=Lt?v.image[st].image:v.image[st],gt[st]=ae(v,gt[st]);let dt=gt[0],Ut=r.convert(v.format,v.colorSpace),zt=r.convert(v.type),Ht=_(v.internalFormat,Ut,zt,v.normalized,v.colorSpace),B=v.isVideoTexture!==!0,ht=rt.__version===void 0||W===!0,tt=K.dataReady,pt=S(v,dt);yt(n.TEXTURE_CUBE_MAP,v);let bt;if(ft){B&&ht&&e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,dt.width,dt.height);for(let st=0;st<6;st++){bt=gt[st].mipmaps;for(let Rt=0;Rt<bt.length;Rt++){let Tt=bt[Rt];v.format!==un?Ut!==null?B?tt&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt,0,0,Tt.width,Tt.height,Ut,Tt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt,Ht,Tt.width,Tt.height,0,Tt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):B?tt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt,0,0,Tt.width,Tt.height,Ut,zt,Tt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt,Ht,Tt.width,Tt.height,0,Ut,zt,Tt.data)}}}else{if(bt=v.mipmaps,B&&ht){bt.length>0&&pt++;let st=Gt(gt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Ht,st.width,st.height)}for(let st=0;st<6;st++)if(Lt){B?tt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,gt[st].width,gt[st].height,Ut,zt,gt[st].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Ht,gt[st].width,gt[st].height,0,Ut,zt,gt[st].data);for(let Rt=0;Rt<bt.length;Rt++){let pe=bt[Rt].image[st].image;B?tt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt+1,0,0,pe.width,pe.height,Ut,zt,pe.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt+1,Ht,pe.width,pe.height,0,Ut,zt,pe.data)}}else{B?tt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,Ut,zt,gt[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Ht,Ut,zt,gt[st]);for(let Rt=0;Rt<bt.length;Rt++){let Tt=bt[Rt];B?tt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt+1,0,0,Ut,zt,Tt.image[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,Rt+1,Ht,Ut,zt,Tt.image[st])}}}f(v)&&b(n.TEXTURE_CUBE_MAP),rt.__version=K.version,v.onUpdate&&v.onUpdate(v)}C.__version=v.version}function wt(C,v,k,W,K,rt){let ct=r.convert(k.format,k.colorSpace),j=r.convert(k.type),Q=_(k.internalFormat,ct,j,k.normalized,k.colorSpace),ft=i.get(v),Lt=i.get(k);if(Lt.__renderTarget=v,!ft.__hasExternalTextures){let gt=Math.max(1,v.width>>rt),dt=Math.max(1,v.height>>rt);K===n.TEXTURE_3D||K===n.TEXTURE_2D_ARRAY?e.texImage3D(K,rt,Q,gt,dt,v.depth,0,ct,j,null):e.texImage2D(K,rt,Q,gt,dt,0,ct,j,null)}e.bindFramebuffer(n.FRAMEBUFFER,C),Kt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,K,Lt.__webglTexture,0,Et(v)):(K===n.TEXTURE_2D||K>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&K<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,K,Lt.__webglTexture,rt),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Qt(C,v,k){if(n.bindRenderbuffer(n.RENDERBUFFER,C),v.depthBuffer){let W=v.depthTexture,K=W&&W.isDepthTexture?W.type:null,rt=M(v.stencilBuffer,K),ct=v.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;Kt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Et(v),rt,v.width,v.height):k?n.renderbufferStorageMultisample(n.RENDERBUFFER,Et(v),rt,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,rt,v.width,v.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ct,n.RENDERBUFFER,C)}else{let W=v.textures;for(let K=0;K<W.length;K++){let rt=W[K],ct=r.convert(rt.format,rt.colorSpace),j=r.convert(rt.type),Q=_(rt.internalFormat,ct,j,rt.normalized,rt.colorSpace);Kt(v)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Et(v),Q,v.width,v.height):k?n.renderbufferStorageMultisample(n.RENDERBUFFER,Et(v),Q,v.width,v.height):n.renderbufferStorage(n.RENDERBUFFER,Q,v.width,v.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function ut(C,v,k){let W=v.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,C),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let K=i.get(v.depthTexture);if(K.__renderTarget=v,(!K.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),W){if(K.__webglInit===void 0&&(K.__webglInit=!0,v.depthTexture.addEventListener("dispose",w)),K.__webglTexture===void 0){K.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,K.__webglTexture),yt(n.TEXTURE_CUBE_MAP,v.depthTexture);let ft=r.convert(v.depthTexture.format),Lt=r.convert(v.depthTexture.type),gt;v.depthTexture.format===Fn?gt=n.DEPTH_COMPONENT24:v.depthTexture.format===Ei&&(gt=n.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,gt,v.width,v.height,0,ft,Lt,null)}}else O(v.depthTexture,0);let rt=K.__webglTexture,ct=Et(v),j=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+k:n.TEXTURE_2D,Q=v.depthTexture.format===Ei?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(v.depthTexture.format===Fn)Kt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,j,rt,0,ct):n.framebufferTexture2D(n.FRAMEBUFFER,Q,j,rt,0);else if(v.depthTexture.format===Ei)Kt(v)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,j,rt,0,ct):n.framebufferTexture2D(n.FRAMEBUFFER,Q,j,rt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ct(C){let v=i.get(C),k=C.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==C.depthTexture){let W=C.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),W){let K=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,W.removeEventListener("dispose",K)};W.addEventListener("dispose",K),v.__depthDisposeCallback=K}v.__boundDepthTexture=W}if(C.depthTexture&&!v.__autoAllocateDepthBuffer)if(k)for(let W=0;W<6;W++)ut(v.__webglFramebuffer[W],C,W);else{let W=C.texture.mipmaps;W&&W.length>0?ut(v.__webglFramebuffer[0],C,0):ut(v.__webglFramebuffer,C,0)}else if(k){v.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(e.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[W]),v.__webglDepthbuffer[W]===void 0)v.__webglDepthbuffer[W]=n.createRenderbuffer(),Qt(v.__webglDepthbuffer[W],C,!1);else{let K=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,rt=v.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,rt),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,rt)}}else{let W=C.texture.mipmaps;if(W&&W.length>0?e.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=n.createRenderbuffer(),Qt(v.__webglDepthbuffer,C,!1);else{let K=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,rt=v.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,rt),n.framebufferRenderbuffer(n.FRAMEBUFFER,K,n.RENDERBUFFER,rt)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function kt(C,v,k){let W=i.get(C);v!==void 0&&wt(W.__webglFramebuffer,C,C.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),k!==void 0&&Ct(C)}function Zt(C){let v=C.texture,k=i.get(C),W=i.get(v);C.addEventListener("dispose",y);let K=C.textures,rt=C.isWebGLCubeRenderTarget===!0,ct=K.length>1;if(ct||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=v.version,a.memory.textures++),rt){k.__webglFramebuffer=[];for(let j=0;j<6;j++)if(v.mipmaps&&v.mipmaps.length>0){k.__webglFramebuffer[j]=[];for(let Q=0;Q<v.mipmaps.length;Q++)k.__webglFramebuffer[j][Q]=n.createFramebuffer()}else k.__webglFramebuffer[j]=n.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){k.__webglFramebuffer=[];for(let j=0;j<v.mipmaps.length;j++)k.__webglFramebuffer[j]=n.createFramebuffer()}else k.__webglFramebuffer=n.createFramebuffer();if(ct)for(let j=0,Q=K.length;j<Q;j++){let ft=i.get(K[j]);ft.__webglTexture===void 0&&(ft.__webglTexture=n.createTexture(),a.memory.textures++)}if(C.samples>0&&Kt(C)===!1){k.__webglMultisampledFramebuffer=n.createFramebuffer(),k.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,k.__webglMultisampledFramebuffer);for(let j=0;j<K.length;j++){let Q=K[j];k.__webglColorRenderbuffer[j]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,k.__webglColorRenderbuffer[j]);let ft=r.convert(Q.format,Q.colorSpace),Lt=r.convert(Q.type),gt=_(Q.internalFormat,ft,Lt,Q.normalized,Q.colorSpace,C.isXRRenderTarget===!0),dt=Et(C);n.renderbufferStorageMultisample(n.RENDERBUFFER,dt,gt,C.width,C.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+j,n.RENDERBUFFER,k.__webglColorRenderbuffer[j])}n.bindRenderbuffer(n.RENDERBUFFER,null),C.depthBuffer&&(k.__webglDepthRenderbuffer=n.createRenderbuffer(),Qt(k.__webglDepthRenderbuffer,C,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(rt){e.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),yt(n.TEXTURE_CUBE_MAP,v);for(let j=0;j<6;j++)if(v.mipmaps&&v.mipmaps.length>0)for(let Q=0;Q<v.mipmaps.length;Q++)wt(k.__webglFramebuffer[j][Q],C,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,Q);else wt(k.__webglFramebuffer[j],C,v,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+j,0);f(v)&&b(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ct){for(let j=0,Q=K.length;j<Q;j++){let ft=K[j],Lt=i.get(ft),gt=n.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(gt=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(gt,Lt.__webglTexture),yt(gt,ft),wt(k.__webglFramebuffer,C,ft,n.COLOR_ATTACHMENT0+j,gt,0),f(ft)&&b(gt)}e.unbindTexture()}else{let j=n.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(j=C.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(j,W.__webglTexture),yt(j,v),v.mipmaps&&v.mipmaps.length>0)for(let Q=0;Q<v.mipmaps.length;Q++)wt(k.__webglFramebuffer[Q],C,v,n.COLOR_ATTACHMENT0,j,Q);else wt(k.__webglFramebuffer,C,v,n.COLOR_ATTACHMENT0,j,0);f(v)&&b(j),e.unbindTexture()}C.depthBuffer&&Ct(C)}function te(C){let v=C.textures;for(let k=0,W=v.length;k<W;k++){let K=v[k];if(f(K)){let rt=A(C),ct=i.get(K).__webglTexture;e.bindTexture(rt,ct),b(rt),e.unbindTexture()}}}let ye=[],at=[];function lt(C){if(C.samples>0){if(Kt(C)===!1){let v=C.textures,k=C.width,W=C.height,K=n.COLOR_BUFFER_BIT,rt=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ct=i.get(C),j=v.length>1;if(j)for(let ft=0;ft<v.length;ft++)e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ft,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ft,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,ct.__webglMultisampledFramebuffer);let Q=C.texture.mipmaps;Q&&Q.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglFramebuffer);for(let ft=0;ft<v.length;ft++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(K|=n.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(K|=n.STENCIL_BUFFER_BIT)),j){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ct.__webglColorRenderbuffer[ft]);let Lt=i.get(v[ft]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Lt,0)}n.blitFramebuffer(0,0,k,W,0,0,k,W,K,n.NEAREST),l===!0&&(ye.length=0,at.length=0,ye.push(n.COLOR_ATTACHMENT0+ft),C.depthBuffer&&C.resolveDepthBuffer===!1&&(ye.push(rt),at.push(rt),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,at)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,ye))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),j)for(let ft=0;ft<v.length;ft++){e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ft,n.RENDERBUFFER,ct.__webglColorRenderbuffer[ft]);let Lt=i.get(v[ft]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ft,n.TEXTURE_2D,Lt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){let v=C.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[v])}}}function Et(C){return Math.min(s.maxSamples,C.samples)}function Kt(C){let v=i.get(C);return C.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function F(C){let v=a.render.frame;h.get(C)!==v&&(h.set(C,v),C.update())}function ae(C,v){let k=C.colorSpace,W=C.format,K=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||k!==Qs&&k!==ti&&(Jt.getTransfer(k)===ee?(W!==un||K!==on)&&Ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Bt("WebGLTextures: Unsupported texture color space:",k)),v}function Gt(C){return typeof HTMLImageElement!="undefined"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame!="undefined"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=U,this.resetTextureUnits=H,this.getTextureUnits=R,this.setTextureUnits=D,this.setTexture2D=O,this.setTexture2DArray=q,this.setTexture3D=$,this.setTextureCube=nt,this.rebindTextures=kt,this.setupRenderTarget=Zt,this.updateRenderTargetMipmap=te,this.updateMultisampleRenderTarget=lt,this.setupDepthRenderbuffer=Ct,this.setupFrameBufferTexture=wt,this.useMultisampledRTT=Kt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function Hv(n,t){function e(i,s=ti){let r,a=Jt.getTransfer(s);if(i===on)return n.UNSIGNED_BYTE;if(i===vo)return n.UNSIGNED_SHORT_4_4_4_4;if(i===bo)return n.UNSIGNED_SHORT_5_5_5_1;if(i===zc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===kc)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Oc)return n.BYTE;if(i===Bc)return n.SHORT;if(i===Rs)return n.UNSIGNED_SHORT;if(i===yo)return n.INT;if(i===Sn)return n.UNSIGNED_INT;if(i===wn)return n.FLOAT;if(i===zn)return n.HALF_FLOAT;if(i===Vc)return n.ALPHA;if(i===Gc)return n.RGB;if(i===un)return n.RGBA;if(i===Fn)return n.DEPTH_COMPONENT;if(i===Ei)return n.DEPTH_STENCIL;if(i===Hc)return n.RED;if(i===Mo)return n.RED_INTEGER;if(i===Ti)return n.RG;if(i===So)return n.RG_INTEGER;if(i===wo)return n.RGBA_INTEGER;if(i===Er||i===Tr||i===Ar||i===Cr)if(a===ee)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Er)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Tr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ar)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Cr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Er)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Tr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ar)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Cr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Eo||i===To||i===Ao||i===Co)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Eo)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===To)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===Ao)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Co)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Ro||i===Io||i===Po||i===Lo||i===Do||i===Rr||i===No)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Ro||i===Io)return a===ee?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Po)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===Lo)return r.COMPRESSED_R11_EAC;if(i===Do)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Rr)return r.COMPRESSED_RG11_EAC;if(i===No)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Uo||i===Fo||i===Oo||i===Bo||i===zo||i===ko||i===Vo||i===Go||i===Ho||i===Wo||i===Xo||i===qo||i===Yo||i===Zo)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Uo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Fo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Oo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Bo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===zo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===ko)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Vo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Go)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Ho)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Wo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Xo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===qo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Yo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Zo)return a===ee?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===$o||i===Jo||i===Ko)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===$o)return a===ee?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Jo)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Ko)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===jo||i===Qo||i===Ir||i===tl)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===jo)return r.COMPRESSED_RED_RGTC1_EXT;if(i===Qo)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Ir)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===tl)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Is?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}var Wv=`
void main() {
