...
`)}var pv={[Oc]:"Linear",[Bc]:"Reinhard",[zc]:"Cineon",[kc]:"ACESFilmic",[Gc]:"AgX",[Hc]:"Neutral",[Vc]:"Custom"};function mv(n,t){let e=pv[t];return e===void 0?(Lt("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var ul=new V;function gv(){jt.getLuminanceCoefficients(ul);let n=ul.x.toFixed(4),t=ul.y.toFixed(4),e=ul.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);let E=v+m+a,_=v+f+o,M=Zf(s,s.VERTEX_SHADER,E),S=Zf(s,s.FRAGMENT_SHADER,_);s.attachShader(y,M),s.attachShader(y,S),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function w(D){if(n.debug.checkShaderErrors){let R=s.getProgramInfoLog(y)||"",B=s.getShaderInfoLog(M)||"",C=s.getShaderInfoLog(S)||"",U=R.trim(),F=B.trim(),L=C.trim(),O=!0,X=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(O=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,M,S);else{let Z=Jf(s,M,"vertex"),Q=Jf(s,S,"fragment");Ut("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
Program Info Log: `+U+`
`+Z+`
`+Q)}else U!==""?Lt("WebGLProgram: Program Info Log:",U):(F===""||L==="")&&(X=!1);X&&(D.diagnostics={runnable:O,programLog:U,vertexShader:{log:F,prefix:m},fragmentShader:{log:L,prefix:f}})}s.deleteShader(M),s.deleteShader(S),x=new Us(s,y),T=yv(s,y)}let x;this.getUniforms=function(){return x===void 0&&w(this),x};let T;this.getAttributes=function(){return T===void 0&&w(this),T};let I=e.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return I===!1&&(I=s.getProgramParameter(y,cv)),I},this.destroy=function(){i.releaseStatesOfProgram(this),s.deleteProgram(y),this.program=void 0},this.type=e.shaderType,this.name=e.shaderName,this.id=hv++,this.cacheKey=t,this.usedTimes=1,this.program=y,this.vertexShader=M,this.fragmentShader=S,this}var Uv=0,Mh=class{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(t,e,i){let s=this._getShaderCacheForMaterial(t);return s.has(e)===!1&&(s.add(e),e.usedTimes++),s.has(i)===!1&&(s.add(i),i.usedTimes++),this}remove(t){let e=this.materialCache.get(t);for(let i of e)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(t),this}getVertexShaderStage(t){return this._getShaderStage(t.vertexShader)}getFragmentShaderStage(t){return this._getShaderStage(t.fragmentShader)}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(t){let e=this.materialCache,i=e.get(t);return i===void 0&&(i=new Set,e.set(t,i)),i}_getShaderStage(t){let e=this.shaderCache,i=e.get(t);return i===void 0&&(i=new Sh(t),e.set(t,i)),i}},Sh=class{constructor(t){this.id=Uv++,this.code=t,this.usedTimes=0}};function Fv(n){return n===Ii||n===Dr||n===Lr}function Ov(n,t,e,i,s,r){let a=new ws,o=new Mh,c=new Set,l=[],h=new Map,d=i.logarithmicDepthBuffer,u=i.precision,p={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function g(x){return c.add(x),x===0?"uv":`uv${x}`}function y(x,T,I,D,R,B){let C=D.fog,U=R.geometry,F=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?D.environment:null,L=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap,O=t.get(x.envMap||F,L),X=O&&O.mapping===Tr?O.image.height:null,Z=p[x.type];x.precision!==null&&(u=i.getMaxPrecision(x.precision),u!==x.precision&&Lt("WebGLProgram.getParameters:",x.precision,"not supported, using",u,"instead."));let Q=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,it=Q!==void 0?Q.length:0,It=0;U.morphAttributes.position!==void 0&&(It=1),U.morphAttributes.normal!==void 0&&(It=2),U.morphAttributes.color!==void 0&&(It=3);let Ot,Nt,z,tt;if(Z){let wt=Hn[Z];Ot=wt.vertexShader,Nt=wt.fragmentShader}else{Ot=x.vertexShader,Nt=x.fragmentShader;let wt=o.getVertexShaderStage(x),me=o.getFragmentShaderStage(x);o.update(x,wt,me),z=wt.id,tt=me.id}let j=n.getRenderTarget(),dt=n.state.buffers.depth.getReversed(),xt=R.isInstancedMesh===!0,vt=R.isBatchedMesh===!0,Zt=!!x.map,zt=!!x.matcap,Ht=!!O,kt=!!x.aoMap,Gt=!!x.lightMap,Mt=!!x.bumpMap&&x.wireframe===!1,Bt=!!x.normalMap,Kt=!!x.displacementMap,ee=!!x.emissiveMap,te=!!x.metalnessMap,xe=!!x.roughnessMap,N=x.anisotropy>0,ct=x.clearcoat>0,yt=x.dispersion>0,P=x.iridescence>0,b=x.sheen>0,G=x.transmission>0,W=N&&!!x.anisotropyMap,J=ct&&!!x.clearcoatMap,rt=ct&&!!x.clearcoatNormalMap,at=ct&&!!x.clearcoatRoughnessMap,K=P&&!!x.iridescenceMap,et=P&&!!x.iridescenceThicknessMap,lt=b&&!!x.sheenColorMap,Tt=b&&!!x.sheenRoughnessMap,ut=!!x.specularMap,ot=!!x.specularColorMap,Dt=!!x.specularIntensityMap,Ft=G&&!!x.transmissionMap,Wt=G&&!!x.thicknessMap,k=!!x.gradientMap,ht=!!x.alphaMap,nt=x.alphaTest>0,ft=!!x.alphaHash,_t=!!x.extensions,st=Sn;x.toneMapped&&(j===null||j.isXRRenderTarget===!0)&&(st=n.toneMapping);let At={shaderID:Z,shaderType:x.type,shaderName:x.name,vertexShader:Ot,fragmentShader:Nt,defines:x.defines,customVertexShaderID:z,customFragmentShaderID:tt,isRawShaderMaterial:x.isRawShaderMaterial===!0,glslVersion:x.glslVersion,precision:u,batching:vt,batchingColor:vt&&R._colorsTexture!==null,instancing:xt,instancingColor:xt&&R.instanceColor!==null,instancingMorph:xt&&R.morphTexture!==null,outputColorSpace:j===null?n.outputColorSpace:j.isXRRenderTarget===!0?j.texture.colorSpace:jt.workingColorSpace,alphaToCoverage:!!x.alphaToCoverage,map:Zt,matcap:zt,envMap:Ht,envMapMode:Ht&&O.mapping,envMapCubeUVHeight:X,aoMap:kt,lightMap:Gt,bumpMap:Mt,normalMap:Bt,displacementMap:Kt,emissiveMap:ee,normalMapObjectSpace:Bt&&x.normalMapType===Mf,normalMapTangentSpace:Bt&&x.normalMapType===jc,packedNormalMap:Bt&&x.normalMapType===jc&&Fv(x.normalMap.format),metalnessMap:te,roughnessMap:xe,anisotropy:N,anisotropyMap:W,clearcoat:ct,clearcoatMap:J,clearcoatNormalMap:rt,clearcoatRoughnessMap:at,dispersion:yt,iridescence:P,iridescenceMap:K,iridescenceThicknessMap:et,sheen:b,sheenColorMap:lt,sheenRoughnessMap:Tt,specularMap:ut,specularColorMap:ot,specularIntensityMap:Dt,transmission:G,transmissionMap:Ft,thicknessMap:Wt,gradientMap:k,opaque:x.transparent===!1&&x.blending===Xi&&x.alphaToCoverage===!1,alphaMap:ht,alphaTest:nt,alphaHash:ft,combine:x.combine,mapUv:Zt&&g(x.map.channel),aoMapUv:kt&&g(x.aoMap.channel),lightMapUv:Gt&&g(x.lightMap.channel),bumpMapUv:Mt&&g(x.bumpMap.channel),normalMapUv:Bt&&g(x.normalMap.channel),displacementMapUv:Kt&&g(x.displacementMap.channel),emissiveMapUv:ee&&g(x.emissiveMap.channel),metalnessMapUv:te&&g(x.metalnessMap.channel),roughnessMapUv:xe&&g(x.roughnessMap.channel),anisotropyMapUv:W&&g(x.anisotropyMap.channel),clearcoatMapUv:J&&g(x.clearcoatMap.channel),clearcoatNormalMapUv:rt&&g(x.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:at&&g(x.clearcoatRoughnessMap.channel),iridescenceMapUv:K&&g(x.iridescenceMap.channel),iridescenceThicknessMapUv:et&&g(x.iridescenceThicknessMap.channel),sheenColorMapUv:lt&&g(x.sheenColorMap.channel),sheenRoughnessMapUv:Tt&&g(x.sheenRoughnessMap.channel),specularMapUv:ut&&g(x.specularMap.channel),specularColorMapUv:ot&&g(x.specularColorMap.channel),specularIntensityMapUv:Dt&&g(x.specularIntensityMap.channel),transmissionMapUv:Ft&&g(x.transmissionMap.channel),thicknessMapUv:Wt&&g(x.thicknessMap.channel),alphaMapUv:ht&&g(x.alphaMap.channel),vertexTangents:!!U.attributes.tangent&&(Bt||N),vertexNormals:!!U.attributes.normal,vertexColors:x.vertexColors,vertexAlphas:x.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,pointsUvs:R.isPoints===!0&&!!U.attributes.uv&&(Zt||ht),fog:!!C,useFog:x.fog===!0,fogExp2:!!C&&C.isFogExp2,flatShading:x.wireframe===!1&&(x.flatShading===!0||U.attributes.normal===void 0&&Bt===!1&&(x.isMeshLambertMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isMeshPhysicalMaterial)),sizeAttenuation:x.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:dt,skinning:R.isSkinnedMesh===!0,hasPositionAttribute:U.attributes.position!==void 0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:it,morphTextureStride:It,numDirLights:T.directional.length,numPointLights:T.point.length,numSpotLights:T.spot.length,numSpotLightMaps:T.spotLightMap.length,numRectAreaLights:T.rectArea.length,numHemiLights:T.hemi.length,numDirLightShadows:T.directionalShadowMap.length,numPointLightShadows:T.pointShadowMap.length,numSpotLightShadows:T.spotShadowMap.length,numSpotLightShadowsWithMaps:T.numSpotLightShadowsWithMaps,numLightProbes:T.numLightProbes,numLightProbeGrids:B.length,numClippingPlanes:r.numPlanes,numClipIntersection:r.numIntersection,dithering:x.dithering,shadowMapEnabled:n.shadowMap.enabled&&I.length>0,shadowMapType:n.shadowMap.type,toneMapping:st,decodeVideoTexture:Zt&&x.map.isVideoTexture===!0&&jt.getTransfer(x.map.colorSpace)===ne,decodeVideoTextureEmissive:ee&&x.emissiveMap.isVideoTexture===!0&&jt.getTransfer(x.emissiveMap.colorSpace)===ne,premultipliedAlpha:x.premultipliedAlpha,doubleSided:x.side===zn,flipSided:x.side===We,useDepthPacking:x.depthPacking>=0,depthPacking:x.depthPacking||0,index0AttributeName:x.index0AttributeName,extensionClipCullDistance:_t&&x.extensions.clipCullDistance===!0&&e.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(_t&&x.extensions.multiDraw===!0||vt)&&e.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:e.has("KHR_parallel_shader_compile"),customProgramCacheKey:x.customProgramCacheKey()};return At.vertexUv1s=c.has(1),At.vertexUv2s=c.has(2),At.vertexUv3s=c.has(3),c.clear(),At}function m(x){let T=[];if(x.shaderID?T.push(x.shaderID):(T.push(x.customVertexShaderID),T.push(x.customFragmentShaderID)),x.defines!==void 0)for(let I in x.defines)T.push(I),T.push(x.defines[I]);return x.isRawShaderMaterial===!1&&(f(T,x),v(T,x),T.push(n.outputColorSpace)),T.push(x.customProgramCacheKey),T.join()}function f(x,T){x.push(T.precision),x.push(T.outputColorSpace),x.push(T.envMapMode),x.push(T.envMapCubeUVHeight),x.push(T.mapUv),x.push(T.alphaMapUv),x.push(T.lightMapUv),x.push(T.aoMapUv),x.push(T.bumpMapUv),x.push(T.normalMapUv),x.push(T.displacementMapUv),x.push(T.emissiveMapUv),x.push(T.metalnessMapUv),x.push(T.roughnessMapUv),x.push(T.anisotropyMapUv),x.push(T.clearcoatMapUv),x.push(T.clearcoatNormalMapUv),x.push(T.clearcoatRoughnessMapUv),x.push(T.iridescenceMapUv),x.push(T.iridescenceThicknessMapUv),x.push(T.sheenColorMapUv),x.push(T.sheenRoughnessMapUv),x.push(T.specularMapUv),x.push(T.specularColorMapUv),x.push(T.specularIntensityMapUv),x.push(T.transmissionMapUv),x.push(T.thicknessMapUv),x.push(T.combine),x.push(T.fogExp2),x.push(T.sizeAttenuation),x.push(T.morphTargetsCount),x.push(T.morphAttributeCount),x.push(T.numDirLights),x.push(T.numPointLights),x.push(T.numSpotLights),x.push(T.numSpotLightMaps),x.push(T.numHemiLights),x.push(T.numRectAreaLights),x.push(T.numDirLightShadows),x.push(T.numPointLightShadows),x.push(T.numSpotLightShadows),x.push(T.numSpotLightShadowsWithMaps),x.push(T.numLightProbes),x.push(T.shadowMapType),x.push(T.toneMapping),x.push(T.numClippingPlanes),x.push(T.numClipIntersection),x.push(T.depthPacking)}function v(x,T){a.disableAll(),T.instancing&&a.enable(0),T.instancingColor&&a.enable(1),T.instancingMorph&&a.enable(2),T.matcap&&a.enable(3),T.envMap&&a.enable(4),T.normalMapObjectSpace&&a.enable(5),T.normalMapTangentSpace&&a.enable(6),T.clearcoat&&a.enable(7),T.iridescence&&a.enable(8),T.alphaTest&&a.enable(9),T.vertexColors&&a.enable(10),T.vertexAlphas&&a.enable(11),T.vertexUv1s&&a.enable(12),T.vertexUv2s&&a.enable(13),T.vertexUv3s&&a.enable(14),T.vertexTangents&&a.enable(15),T.anisotropy&&a.enable(16),T.alphaHash&&a.enable(17),T.batching&&a.enable(18),T.dispersion&&a.enable(19),T.batchingColor&&a.enable(20),T.gradientMap&&a.enable(21),T.packedNormalMap&&a.enable(22),T.vertexNormals&&a.enable(23),x.push(a.mask),a.disableAll(),T.fog&&a.enable(0),T.useFog&&a.enable(1),T.flatShading&&a.enable(2),T.logarithmicDepthBuffer&&a.enable(3),T.reversedDepthBuffer&&a.enable(4),T.skinning&&a.enable(5),T.morphTargets&&a.enable(6),T.morphNormals&&a.enable(7),T.morphColors&&a.enable(8),T.premultipliedAlpha&&a.enable(9),T.shadowMapEnabled&&a.enable(10),T.doubleSided&&a.enable(11),T.flipSided&&a.enable(12),T.useDepthPacking&&a.enable(13),T.dithering&&a.enable(14),T.transmission&&a.enable(15),T.sheen&&a.enable(16),T.opaque&&a.enable(17),T.pointsUvs&&a.enable(18),T.decodeVideoTexture&&a.enable(19),T.decodeVideoTextureEmissive&&a.enable(20),T.alphaToCoverage&&a.enable(21),T.numLightProbeGrids>0&&a.enable(22),T.hasPositionAttribute&&a.enable(23),x.push(a.mask)}function E(x){let T=p[x.type],I;if(T){let D=Hn[T];I=Uf.clone(D.uniforms)}else I=x.uniforms;return I}function _(x,T){let I=h.get(T);return I!==void 0?++I.usedTimes:(I=new Nv(n,T,x,s),l.push(I),h.set(T,I)),I}function M(x){if(--x.usedTimes===0){let T=l.indexOf(x);l[T]=l[l.length-1],l.pop(),h.delete(x.cacheKey),x.destroy()}}function S(x){o.remove(x)}function w(){o.dispose()}return{getParameters:y,getProgramCacheKey:m,getUniforms:E,acquireProgram:_,releaseProgram:M,releaseShaderCache:S,programs:l,dispose:w}}function Bv(){let n=new WeakMap;function t(a){return n.has(a)}function e(a){let o=n.get(a);return o===void 0&&(o={},n.set(a,o)),o}function i(a){n.delete(a)}function s(a,o,c){n.get(a)[o]=c}function r(){n=new WeakMap}return{has:t,get:e,remove:i,update:s,dispose:r}}function zv(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.material.id!==t.material.id?n.material.id-t.material.id:n.materialVariant!==t.materialVariant?n.materialVariant-t.materialVariant:n.z!==t.z?n.z-t.z:n.id-t.id}function ed(n,t){return n.groupOrder!==t.groupOrder?n.groupOrder-t.groupOrder:n.renderOrder!==t.renderOrder?n.renderOrder-t.renderOrder:n.z!==t.z?t.z-n.z:n.id-t.id}function nd(){let n=[],t=0,e=[],i=[],s=[];function r(){t=0,e.length=0,i.length=0,s.length=0}function a(u){let p=0;return u.isInstancedMesh&&(p+=2),u.isSkinnedMesh&&(p+=1),p}function o(u,p,g,y,m,f){let v=n[t];return v===void 0?(v={id:u.id,object:u,geometry:p,material:g,materialVariant:a(u),groupOrder:y,renderOrder:u.renderOrder,z:m,group:f},n[t]=v):(v.id=u.id,v.object=u,v.geometry=p,v.material=g,v.materialVariant=a(u),v.groupOrder=y,v.renderOrder=u.renderOrder,v.z=m,v.group=f),t++,v}function c(u,p,g,y,m,f){let v=o(u,p,g,y,m,f);g.transmission>0?i.push(v):g.transparent===!0?s.push(v):e.push(v)}function l(u,p,g,y,m,f){let v=o(u,p,g,y,m,f);g.transmission>0?i.unshift(v):g.transparent===!0?s.unshift(v):e.unshift(v)}function h(u,p,g){e.length>1&&e.sort(u||zv),i.length>1&&i.sort(p||ed),s.length>1&&s.sort(p||ed),g&&(e.reverse(),i.reverse(),s.reverse())}function d(){for(let u=t,p=n.length;u<p;u++){let g=n[u];if(g.id===null)break;g.id=null,g.object=null,g.geometry=null,g.material=null,g.group=null}}return{opaque:e,transmissive:i,transparent:s,init:r,push:c,unshift:l,finish:d,sort:h}}function kv(){let n=new WeakMap;function t(i,s){let r=n.get(i),a;return r===void 0?(a=new nd,n.set(i,[a])):s>=r.length?(a=new nd,r.push(a)):a=r[s],a}function e(){n=new WeakMap}return{get:t,dispose:e}}function Vv(){let n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={direction:new V,color:new Jt};break;case"SpotLight":e={position:new V,direction:new V,color:new Jt,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":e={position:new V,color:new Jt,distance:0,decay:0};break;case"HemisphereLight":e={direction:new V,skyColor:new Jt,groundColor:new Jt};break;case"RectAreaLight":e={color:new Jt,position:new V,halfWidth:new V,halfHeight:new V};break}return n[t.id]=e,e}}}function Gv(){let n={};return{get:function(t){if(n[t.id]!==void 0)return n[t.id];let e;switch(t.type){case"DirectionalLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"SpotLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt};break;case"PointLight":e={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Rt,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[t.id]=e,e}}}var Hv=0;function Wv(n,t){return(t.castShadow?2:0)-(n.castShadow?2:0)+(t.map?1:0)-(n.map?1:0)}function Xv(n){let t=new Vv,e=Gv(),i={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let l=0;l<9;l++)i.probe.push(new V);let s=new V,r=new de,a=new de;function o(l){let h=0,d=0,u=0;for(let T=0;T<9;T++)i.probe[T].set(0,0,0);let p=0,g=0,y=0,m=0,f=0,v=0,E=0,_=0,M=0,S=0,w=0;l.sort(Wv);for(let T=0,I=l.length;T<I;T++){let D=l[T],R=D.color,B=D.intensity,C=D.distance,U=null;if(D.shadow&&D.shadow.map&&(D.shadow.map.texture.format===Ii?U=D.shadow.map.texture:U=D.shadow.map.depthTexture||D.shadow.map.texture),D.isAmbientLight)h+=R.r*B,d+=R.g*B,u+=R.b*B;else if(D.isLightProbe){for(let F=0;F<9;F++)i.probe[F].addScaledVector(D.sh.coefficients[F],B);w++}else if(D.isDirectionalLight){let F=t.get(D);if(F.color.copy(D.color).multiplyScalar(D.intensity),D.castShadow){let L=D.shadow,O=e.get(D);O.shadowIntensity=L.intensity,O.shadowBias=L.bias,O.shadowNormalBias=L.normalBias,O.shadowRadius=L.radius,O.shadowMapSize=L.mapSize,i.directionalShadow[p]=O,i.directionalShadowMap[p]=U,i.directionalShadowMatrix[p]=D.shadow.matrix,v++}i.directional[p]=F,p++}else if(D.isSpotLight){let F=t.get(D);F.position.setFromMatrixPosition(D.matrixWorld),F.color.copy(R).multiplyScalar(B),F.distance=C,F.coneCos=Math.cos(D.angle),F.penumbraCos=Math.cos(D.angle*(1-D.penumbra)),F.decay=D.decay,i.spot[y]=F;let L=D.shadow;if(D.map&&(i.spotLightMap[M]=D.map,M++,L.updateMatrices(D),D.castShadow&&S++),i.spotLightMatrix[y]=L.matrix,D.castShadow){let O=e.get(D);O.shadowIntensity=L.intensity,O.shadowBias=L.bias,O.shadowNormalBias=L.normalBias,O.shadowRadius=L.radius,O.shadowMapSize=L.mapSize,i.spotShadow[y]=O,i.spotShadowMap[y]=U,_++}y++}else if(D.isRectAreaLight){let F=t.get(D);F.color.copy(R).multiplyScalar(B),F.halfWidth.set(D.width*.5,0,0),F.halfHeight.set(0,D.height*.5,0),i.rectArea[m]=F,m++}else if(D.isPointLight){let F=t.get(D);if(F.color.copy(D.color).multiplyScalar(D.intensity),F.distance=D.distance,F.decay=D.decay,D.castShadow){let L=D.shadow,O=e.get(D);O.shadowIntensity=L.intensity,O.shadowBias=L.bias,O.shadowNormalBias=L.normalBias,O.shadowRadius=L.radius,O.shadowMapSize=L.mapSize,O.shadowCameraNear=L.camera.near,O.shadowCameraFar=L.camera.far,i.pointShadow[g]=O,i.pointShadowMap[g]=U,i.pointShadowMatrix[g]=D.shadow.matrix,E++}i.point[g]=F,g++}else if(D.isHemisphereLight){let F=t.get(D);F.skyColor.copy(D.color).multiplyScalar(B),F.groundColor.copy(D.groundColor).multiplyScalar(B),i.hemi[f]=F,f++}}m>0&&(n.has("OES_texture_float_linear")===!0?(i.rectAreaLTC1=pt.LTC_FLOAT_1,i.rectAreaLTC2=pt.LTC_FLOAT_2):(i.rectAreaLTC1=pt.LTC_HALF_1,i.rectAreaLTC2=pt.LTC_HALF_2)),i.ambient[0]=h,i.ambient[1]=d,i.ambient[2]=u;let x=i.hash;(x.directionalLength!==p||x.pointLength!==g||x.spotLength!==y||x.rectAreaLength!==m||x.hemiLength!==f||x.numDirectionalShadows!==v||x.numPointShadows!==E||x.numSpotShadows!==_||x.numSpotMaps!==M||x.numLightProbes!==w)&&(i.directional.length=p,i.spot.length=y,i.rectArea.length=m,i.point.length=g,i.hemi.length=f,i.directionalShadow.length=v,i.directionalShadowMap.length=v,i.pointShadow.length=E,i.pointShadowMap.length=E,i.spotShadow.length=_,i.spotShadowMap.length=_,i.directionalShadowMatrix.length=v,i.pointShadowMatrix.length=E,i.spotLightMatrix.length=_+M-S,i.spotLightMap.length=M,i.numSpotLightShadowsWithMaps=S,i.numLightProbes=w,x.directionalLength=p,x.pointLength=g,x.spotLength=y,x.rectAreaLength=m,x.hemiLength=f,x.numDirectionalShadows=v,x.numPointShadows=E,x.numSpotShadows=_,x.numSpotMaps=M,x.numLightProbes=w,i.version=Hv++)}function c(l,h){let d=0,u=0,p=0,g=0,y=0,m=h.matrixWorldInverse;for(let f=0,v=l.length;f<v;f++){let E=l[f];if(E.isDirectionalLight){let _=i.directional[d];_.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(m),d++}else if(E.isSpotLight){let _=i.spot[p];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(m),_.direction.setFromMatrixPosition(E.matrixWorld),s.setFromMatrixPosition(E.target.matrixWorld),_.direction.sub(s),_.direction.transformDirection(m),p++}else if(E.isRectAreaLight){let _=i.rectArea[g];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(m),a.identity(),r.copy(E.matrixWorld),r.premultiply(m),a.extractRotation(r),_.halfWidth.set(E.width*.5,0,0),_.halfHeight.set(0,E.height*.5,0),_.halfWidth.applyMatrix4(a),_.halfHeight.applyMatrix4(a),g++}else if(E.isPointLight){let _=i.point[u];_.position.setFromMatrixPosition(E.matrixWorld),_.position.applyMatrix4(m),u++}else if(E.isHemisphereLight){let _=i.hemi[y];_.direction.setFromMatrixPosition(E.matrixWorld),_.direction.transformDirection(m),y++}}}return{setup:o,setupView:c,state:i}}function id(n){let t=new Xv(n),e=[],i=[],s=[];function r(u){d.camera=u,e.length=0,i.length=0,s.length=0}function a(u){e.push(u)}function o(u){i.push(u)}function c(u){s.push(u)}function l(){t.setup(e)}function h(u){t.setupView(e,u)}let d={lightsArray:e,shadowsArray:i,lightProbeGridArray:s,camera:null,lights:t,transmissionRenderTarget:{},textureUnits:0};return{init:r,state:d,setupLights:l,setupLightsView:h,pushLight:a,pushShadow:o,pushLightProbeGrid:c}}function qv(n){let t=new WeakMap;function e(s,r=0){let a=t.get(s),o;return a===void 0?(o=new id(n),t.set(s,[o])):r>=a.length?(o=new id(n),a.push(o)):o=a[r],o}function i(){t=new WeakMap}return{get:e,dispose:i}}var Yv=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`,$v=[new V(1,0,0),new V(-1,0,0),new V(0,1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1)],Jv=[new V(0,-1,0),new V(0,-1,0),new V(0,0,1),new V(0,0,-1),new V(0,-1,0),new V(0,-1,0)],sd=new de,Ur=new V,gh=new V;function Kv(n,t,e){let i=new ur,s=new Rt,r=new Rt,a=new pe,o=new ao,c=new oo,l={},h=e.maxTextureSize,d={[Qn]:We,[We]:Qn,[zn]:zn},u=new rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Rt},radius:{value:4}},vertexShader:Yv,fragmentShader:Zv}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let g=new Se;g.setAttribute("position",new Ye(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new He(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Er;let f=this.type;this.render=function(S,w,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;this.type===ju&&(Lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Er);let T=n.getRenderTarget(),I=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),R=n.state;R.setBlending(kn),R.buffers.depth.getReversed()===!0?R.buffers.color.setClear(0,0,0,0):R.buffers.color.setClear(1,1,1,1),R.buffers.depth.setTest(!0),R.setScissorTest(!1);let B=f!==this.type;B&&w.traverse(function(C){C.material&&(Array.isArray(C.material)?C.material.forEach(U=>U.needsUpdate=!0):C.material.needsUpdate=!0)});for(let C=0,U=S.length;C<U;C++){let F=S[C],L=F.shadow;if(L===void 0){Lt("WebGLShadowMap:",F,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);let O=L.getFrameExtents();s.multiply(O),r.copy(L.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/O.x),s.x=r.x*O.x,L.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/O.y),s.y=r.y*O.y,L.mapSize.y=r.y));let X=n.state.buffers.depth.getReversed();if(L.camera._reversedDepth=X,L.map===null||B===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Ps){if(F.isPointLight){Lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new sn(s.x,s.y,{format:Ii,type:Vn,minFilter:De,magFilter:De,generateMipmaps:!1}),L.map.texture.name=F.name+".shadowMap",L.map.depthTexture=new ei(s.x,s.y,En),L.map.depthTexture.name=F.name+".shadowMapDepth",L.map.depthTexture.format=On,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Re,L.map.depthTexture.magFilter=Re}else F.isPointLight?(L.map=new dl(s.x),L.map.depthTexture=new io(s.x,wn)):(L.map=new sn(s.x,s.y),L.map.depthTexture=new ei(s.x,s.y,wn)),L.map.depthTexture.name=F.name+".shadowMap",L.map.depthTexture.format=On,this.type===Er?(L.map.depthTexture.compareFunction=X?cl:ll,L.map.depthTexture.minFilter=De,L.map.depthTexture.magFilter=De):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Re,L.map.depthTexture.magFilter=Re);L.camera.updateProjectionMatrix()}let Z=L.map.isWebGLCubeRenderTarget?6:1;for(let Q=0;Q<Z;Q++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,Q),n.clear();else{Q===0&&(n.setRenderTarget(L.map),n.clear());let it=L.getViewport(Q);a.set(r.x*it.x,r.y*it.y,r.x*it.z,r.y*it.w),R.viewport(a)}if(F.isPointLight){let it=L.camera,It=L.matrix,Ot=F.distance||it.far;Ot!==it.far&&(it.far=Ot,it.updateProjectionMatrix()),Ur.setFromMatrixPosition(F.matrixWorld),it.position.copy(Ur),gh.copy(it.position),gh.add($v[Q]),it.up.copy(Jv[Q]),it.lookAt(gh),it.updateMatrixWorld(),It.makeTranslation(-Ur.x,-Ur.y,-Ur.z),sd.multiplyMatrices(it.projectionMatrix,it.matrixWorldInverse),L._frustum.setFromProjectionMatrix(sd,it.coordinateSystem,it.reversedDepth)}else L.updateMatrices(F);i=L.getFrustum(),_(w,x,L.camera,F,this.type)}L.isPointLightShadow!==!0&&this.type===Ps&&v(L,x),L.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(T,I,D)};function v(S,w){let x=t.update(y);u.defines.VSM_SAMPLES!==S.blurSamples&&(u.defines.VSM_SAMPLES=S.blurSamples,p.defines.VSM_SAMPLES=S.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new sn(s.x,s.y,{format:Ii,type:Vn})),u.uniforms.shadow_pass.value=S.map.depthTexture,u.uniforms.resolution.value=S.mapSize,u.uniforms.radius.value=S.radius,n.setRenderTarget(S.mapPass),n.clear(),n.renderBufferDirect(w,null,x,u,y,null),p.uniforms.shadow_pass.value=S.mapPass.texture,p.uniforms.resolution.value=S.mapSize,p.uniforms.radius.value=S.radius,n.setRenderTarget(S.map),n.clear(),n.renderBufferDirect(w,null,x,p,y,null)}function E(S,w,x,T){let I=null,D=x.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(D!==void 0)I=D;else if(I=x.isPointLight===!0?c:o,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let R=I.uuid,B=w.uuid,C=l[R];C===void 0&&(C={},l[R]=C);let U=C[B];U===void 0&&(U=I.clone(),C[B]=U,w.addEventListener("dispose",M)),I=U}if(I.visible=w.visible,I.wireframe=w.wireframe,T===Ps?I.side=w.shadowSide!==null?w.shadowSide:w.side:I.side=w.shadowSide!==null?w.shadowSide:d[w.side],I.alphaMap=w.alphaMap,I.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,I.map=w.map,I.clipShadows=w.clipShadows,I.clippingPlanes=w.clippingPlanes,I.clipIntersection=w.clipIntersection,I.displacementMap=w.displacementMap,I.displacementScale=w.displacementScale,I.displacementBias=w.displacementBias,I.wireframeLinewidth=w.wireframeLinewidth,I.linewidth=w.linewidth,x.isPointLight===!0&&I.isMeshDistanceMaterial===!0){let R=n.properties.get(I);R.light=x}return I}function _(S,w,x,T,I){if(S.visible===!1)return;if(S.layers.test(w.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&I===Ps)&&(!S.frustumCulled||i.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,S.matrixWorld);let B=t.update(S),C=S.material;if(Array.isArray(C)){let U=B.groups;for(let F=0,L=U.length;F<L;F++){let O=U[F],X=C[O.materialIndex];if(X&&X.visible){let Z=E(S,X,T,I);S.onBeforeShadow(n,S,w,x,B,Z,O),n.renderBufferDirect(x,null,B,Z,S,O),S.onAfterShadow(n,S,w,x,B,Z,O)}}}else if(C.visible){let U=E(S,C,T,I);S.onBeforeShadow(n,S,w,x,B,U,null),n.renderBufferDirect(x,null,B,U,S,null),S.onAfterShadow(n,S,w,x,B,U,null)}}let R=S.children;for(let B=0,C=R.length;B<C;B++)_(R[B],w,x,T,I)}function M(S){S.target.removeEventListener("dispose",M);for(let x in l){let T=l[x],I=S.target.uuid;I in T&&(T[I].dispose(),delete T[I])}}}function jv(n,t){function e(){let k=!1,ht=new pe,nt=null,ft=new pe(0,0,0,0);return{setMask:function(_t){nt!==_t&&!k&&(n.colorMask(_t,_t,_t,_t),nt=_t)},setLocked:function(_t){k=_t},setClear:function(_t,st,At,wt,me){me===!0&&(_t*=wt,st*=wt,At*=wt),ht.set(_t,st,At,wt),ft.equals(ht)===!1&&(n.clearColor(_t,st,At,wt),ft.copy(ht))},reset:function(){k=!1,nt=null,ft.set(-1,0,0,0)}}}function i(){let k=!1,ht=!1,nt=null,ft=null,_t=null;return{setReversed:function(st){if(ht!==st){let At=t.get("EXT_clip_control");st?At.clipControlEXT(At.LOWER_LEFT_EXT,At.ZERO_TO_ONE_EXT):At.clipControlEXT(At.LOWER_LEFT_EXT,At.NEGATIVE_ONE_TO_ONE_EXT),ht=st;let wt=_t;_t=null,this.setClear(wt)}},getReversed:function(){return ht},setTest:function(st){st?j(n.DEPTH_TEST):dt(n.DEPTH_TEST)},setMask:function(st){nt!==st&&!k&&(n.depthMask(st),nt=st)},setFunc:function(st){if(ht&&(st=Df[st]),ft!==st){switch(st){case Ba:n.depthFunc(n.NEVER);break;case za:n.depthFunc(n.ALWAYS);break;case ka:n.depthFunc(n.LESS);break;case qi:n.depthFunc(n.LEQUAL);break;case Va:n.depthFunc(n.EQUAL);break;case Ga:n.depthFunc(n.GEQUAL);break;case Ha:n.depthFunc(n.GREATER);break;case Wa:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ft=st}},setLocked:function(st){k=st},setClear:function(st){_t!==st&&(_t=st,ht&&(st=1-st),n.clearDepth(st))},reset:function(){k=!1,nt=null,ft=null,_t=null,ht=!1}}}function s(){let k=!1,ht=null,nt=null,ft=null,_t=null,st=null,At=null,wt=null,me=null;return{setTest:function(ce){k||(ce?j(n.STENCIL_TEST):dt(n.STENCIL_TEST))},setMask:function(ce){ht!==ce&&!k&&(n.stencilMask(ce),ht=ce)},setFunc:function(ce,Dn,Ln){(nt!==ce||ft!==Dn||_t!==Ln)&&(n.stencilFunc(ce,Dn,Ln),nt=ce,ft=Dn,_t=Ln)},setOp:function(ce,Dn,Ln){(st!==ce||At!==Dn||wt!==Ln)&&(n.stencilOp(ce,Dn,Ln),st=ce,At=Dn,wt=Ln)},setLocked:function(ce){k=ce},setClear:function(ce){me!==ce&&(n.clearStencil(ce),me=ce)},reset:function(){k=!1,ht=null,nt=null,ft=null,_t=null,st=null,At=null,wt=null,me=null}}}let r=new e,a=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},p=new WeakMap,g=[],y=null,m=!1,f=null,v=null,E=null,_=null,M=null,S=null,w=null,x=new Jt(0,0,0),T=0,I=!1,D=null,R=null,B=null,C=null,U=null,F=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),L=!1,O=0,X=n.getParameter(n.VERSION);X.indexOf("WebGL")!==-1?(O=parseFloat(/^WebGL (\d)/.exec(X)[1]),L=O>=1):X.indexOf("OpenGL ES")!==-1&&(O=parseFloat(/^OpenGL ES (\d)/.exec(X)[1]),L=O>=2);let Z=null,Q={},it=n.getParameter(n.SCISSOR_BOX),It=n.getParameter(n.VIEWPORT),Ot=new pe().fromArray(it),Nt=new pe().fromArray(It);function z(k,ht,nt,ft){let _t=new Uint8Array(4),st=n.createTexture();n.bindTexture(k,st),n.texParameteri(k,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(k,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let At=0;At<nt;At++)k===n.TEXTURE_3D||k===n.TEXTURE_2D_ARRAY?n.texImage3D(ht,0,n.RGBA,1,1,ft,0,n.RGBA,n.UNSIGNED_BYTE,_t):n.texImage2D(ht+At,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,_t);return st}let tt={};tt[n.TEXTURE_2D]=z(n.TEXTURE_2D,n.TEXTURE_2D,1),tt[n.TEXTURE_CUBE_MAP]=z(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),tt[n.TEXTURE_2D_ARRAY]=z(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),tt[n.TEXTURE_3D]=z(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(n.DEPTH_TEST),a.setFunc(qi),Mt(!1),Bt(Dc),j(n.CULL_FACE),kt(kn);function j(k){h[k]!==!0&&(n.enable(k),h[k]=!0)}function dt(k){h[k]!==!1&&(n.disable(k),h[k]=!1)}function xt(k,ht){return u[k]!==ht?(n.bindFramebuffer(k,ht),u[k]=ht,k===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=ht),k===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=ht),!0):!1}function vt(k,ht){let nt=g,ft=!1;if(k){nt=p.get(ht),nt===void 0&&(nt=[],p.set(ht,nt));let _t=k.textures;if(nt.length!==_t.length||nt[0]!==n.COLOR_ATTACHMENT0){for(let st=0,At=_t.length;st<At;st++)nt[st]=n.COLOR_ATTACHMENT0+st;nt.length=_t.length,ft=!0}}else nt[0]!==n.BACK&&(nt[0]=n.BACK,ft=!0);ft&&n.drawBuffers(nt)}function Zt(k){return y!==k?(n.useProgram(k),y=k,!0):!1}let zt={[gi]:n.FUNC_ADD,[tf]:n.FUNC_SUBTRACT,[ef]:n.FUNC_REVERSE_SUBTRACT};zt[nf]=n.MIN,zt[sf]=n.MAX;let Ht={[rf]:n.ZERO,[af]:n.ONE,[of]:n.SRC_COLOR,[Fa]:n.SRC_ALPHA,[df]:n.SRC_ALPHA_SATURATE,[uf]:n.DST_COLOR,[cf]:n.DST_ALPHA,[lf]:n.ONE_MINUS_SRC_COLOR,[Oa]:n.ONE_MINUS_SRC_ALPHA,[ff]:n.ONE_MINUS_DST_COLOR,[hf]:n.ONE_MINUS_DST_ALPHA,[pf]:n.CONSTANT_COLOR,[mf]:n.ONE_MINUS_CONSTANT_COLOR,[gf]:n.CONSTANT_ALPHA,[_f]:n.ONE_MINUS_CONSTANT_ALPHA};function kt(k,ht,nt,ft,_t,st,At,wt,me,ce){if(k===kn){m===!0&&(dt(n.BLEND),m=!1);return}if(m===!1&&(j(n.BLEND),m=!0),k!==Qu){if(k!==f||ce!==I){if((v!==gi||M!==gi)&&(n.blendEquation(n.FUNC_ADD),v=gi,M=gi),ce)switch(k){case Xi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Lc:n.blendFunc(n.ONE,n.ONE);break;case Nc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Uc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Ut("WebGLState: Invalid blending: ",k);break}else switch(k){case Xi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Lc:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Nc:Ut("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Uc:Ut("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ut("WebGLState: Invalid blending: ",k);break}E=null,_=null,S=null,w=null,x.set(0,0,0),T=0,f=k,I=ce}return}_t=_t||ht,st=st||nt,At=At||ft,(ht!==v||_t!==M)&&(n.blendEquationSeparate(zt[ht],zt[_t]),v=ht,M=_t),(nt!==E||ft!==_||st!==S||At!==w)&&(n.blendFuncSeparate(Ht[nt],Ht[ft],Ht[st],Ht[At]),E=nt,_=ft,S=st,w=At),(wt.equals(x)===!1||me!==T)&&(n.blendColor(wt.r,wt.g,wt.b,me),x.copy(wt),T=me),f=k,I=!1}function Gt(k,ht){k.side===zn?dt(n.CULL_FACE):j(n.CULL_FACE);let nt=k.side===We;ht&&(nt=!nt),Mt(nt),k.blending===Xi&&k.transparent===!1?kt(kn):kt(k.blending,k.blendEquation,k.blendSrc,k.blendDst,k.blendEquationAlpha,k.blendSrcAlpha,k.blendDstAlpha,k.blendColor,k.blendAlpha,k.premultipliedAlpha),a.setFunc(k.depthFunc),a.setTest(k.depthTest),a.setMask(k.depthWrite),r.setMask(k.colorWrite);let ft=k.stencilWrite;o.setTest(ft),ft&&(o.setMask(k.stencilWriteMask),o.setFunc(k.stencilFunc,k.stencilRef,k.stencilFuncMask),o.setOp(k.stencilFail,k.stencilZFail,k.stencilZPass)),ee(k.polygonOffset,k.polygonOffsetFactor,k.polygonOffsetUnits),k.alphaToCoverage===!0?j(n.SAMPLE_ALPHA_TO_COVERAGE):dt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Mt(k){D!==k&&(k?n.frontFace(n.CW):n.frontFace(n.CCW),D=k)}function Bt(k){k!==Ju?(j(n.CULL_FACE),k!==R&&(k===Dc?n.cullFace(n.BACK):k===Ku?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):dt(n.CULL_FACE),R=k}function Kt(k){k!==B&&(L&&n.lineWidth(k),B=k)}function ee(k,ht,nt){k?(j(n.POLYGON_OFFSET_FILL),(C!==ht||U!==nt)&&(C=ht,U=nt,a.getReversed()&&(ht=-ht),n.polygonOffset(ht,nt))):dt(n.POLYGON_OFFSET_FILL)}function te(k){k?j(n.SCISSOR_TEST):dt(n.SCISSOR_TEST)}function xe(k){k===void 0&&(k=n.TEXTURE0+F-1),Z!==k&&(n.activeTexture(k),Z=k)}function N(k,ht,nt){nt===void 0&&(Z===null?nt=n.TEXTURE0+F-1:nt=Z);let ft=Q[nt];ft===void 0&&(ft={type:void 0,texture:void 0},Q[nt]=ft),(ft.type!==k||ft.texture!==ht)&&(Z!==nt&&(n.activeTexture(nt),Z=nt),n.bindTexture(k,ht||tt[k]),ft.type=k,ft.texture=ht)}function ct(){let k=Q[Z];k!==void 0&&k.type!==void 0&&(n.bindTexture(k.type,null),k.type=void 0,k.texture=void 0)}function yt(){try{n.compressedTexImage2D(...arguments)}catch(k){Ut("WebGLState:",k)}}function P(){try{n.compressedTexImage3D(...arguments)}catch(k){Ut("WebGLState:",k)}}function b(){try{n.texSubImage2D(...arguments)}catch(k){Ut("WebGLState:",k)}}function G(){try{n.texSubImage3D(...arguments)}catch(k){Ut("WebGLState:",k)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(k){Ut("WebGLState:",k)}}function J(){try{n.compressedTexSubImage3D(...arguments)}catch(k){Ut("WebGLState:",k)}}function rt(){try{n.texStorage2D(...arguments)}catch(k){Ut("WebGLState:",k)}}function at(){try{n.texStorage3D(...arguments)}catch(k){Ut("WebGLState:",k)}}function K(){try{n.texImage2D(...arguments)}catch(k){Ut("WebGLState:",k)}}function et(){try{n.texImage3D(...arguments)}catch(k){Ut("WebGLState:",k)}}function lt(k){return d[k]!==void 0?d[k]:n.getParameter(k)}function Tt(k,ht){d[k]!==ht&&(n.pixelStorei(k,ht),d[k]=ht)}function ut(k){Ot.equals(k)===!1&&(n.scissor(k.x,k.y,k.z,k.w),Ot.copy(k))}function ot(k){Nt.equals(k)===!1&&(n.viewport(k.x,k.y,k.z,k.w),Nt.copy(k))}function Dt(k,ht){let nt=l.get(ht);nt===void 0&&(nt=new WeakMap,l.set(ht,nt));let ft=nt.get(k);ft===void 0&&(ft=n.getUniformBlockIndex(ht,k.name),nt.set(k,ft))}function Ft(k,ht){let ft=l.get(ht).get(k);c.get(ht)!==ft&&(n.uniformBlockBinding(ht,ft,k.__bindingPointIndex),c.set(ht,ft))}function Wt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),h={},d={},Z=null,Q={},u={},p=new WeakMap,g=[],y=null,m=!1,f=null,v=null,E=null,_=null,M=null,S=null,w=null,x=new Jt(0,0,0),T=0,I=!1,D=null,R=null,B=null,C=null,U=null,Ot.set(0,0,n.canvas.width,n.canvas.height),Nt.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:dt,bindFramebuffer:xt,drawBuffers:vt,useProgram:Zt,setBlending:kt,setMaterial:Gt,setFlipSided:Mt,setCullFace:Bt,setLineWidth:Kt,setPolygonOffset:ee,setScissorTest:te,activeTexture:xe,bindTexture:N,unbindTexture:ct,compressedTexImage2D:yt,compressedTexImage3D:P,texImage2D:K,texImage3D:et,pixelStorei:Tt,getParameter:lt,updateUBOMapping:Dt,uniformBlockBinding:Ft,texStorage2D:rt,texStorage3D:at,texSubImage2D:b,texSubImage3D:G,compressedTexSubImage2D:W,compressedTexSubImage3D:J,scissor:ut,viewport:ot,reset:Wt}}function Qv(n,t,e,i,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Rt,h=new WeakMap,d=new Set,u,p=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch(P){}function y(P,b){return g?new OffscreenCanvas(P,b):ir("canvas")}function m(P,b,G){let W=1,J=yt(P);if((J.width>G||J.height>G)&&(W=G/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement!="undefined"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&P instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&P instanceof ImageBitmap||typeof VideoFrame!="undefined"&&P instanceof VideoFrame){let rt=Math.floor(W*J.width),at=Math.floor(W*J.height);u===void 0&&(u=y(rt,at));let K=b?y(rt,at):u;return K.width=rt,K.height=at,K.getContext("2d").drawImage(P,0,0,rt,at),Lt("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+rt+"x"+at+")."),K}else return"data"in P&&Lt("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),P;return P}function f(P){return P.generateMipmaps}function v(P){n.generateMipmap(P)}function E(P){return P.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?n.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(P,b,G,W,J,rt=!1){if(P!==null){if(n[P]!==void 0)return n[P];Lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let at;W&&(at=t.get("EXT_texture_norm16"),at||Lt("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let K=b;if(b===n.RED&&(G===n.FLOAT&&(K=n.R32F),G===n.HALF_FLOAT&&(K=n.R16F),G===n.UNSIGNED_BYTE&&(K=n.R8),G===n.UNSIGNED_SHORT&&at&&(K=at.R16_EXT),G===n.SHORT&&at&&(K=at.R16_SNORM_EXT)),b===n.RED_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.R8UI),G===n.UNSIGNED_SHORT&&(K=n.R16UI),G===n.UNSIGNED_INT&&(K=n.R32UI),G===n.BYTE&&(K=n.R8I),G===n.SHORT&&(K=n.R16I),G===n.INT&&(K=n.R32I)),b===n.RG&&(G===n.FLOAT&&(K=n.RG32F),G===n.HALF_FLOAT&&(K=n.RG16F),G===n.UNSIGNED_BYTE&&(K=n.RG8),G===n.UNSIGNED_SHORT&&at&&(K=at.RG16_EXT),G===n.SHORT&&at&&(K=at.RG16_SNORM_EXT)),b===n.RG_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RG8UI),G===n.UNSIGNED_SHORT&&(K=n.RG16UI),G===n.UNSIGNED_INT&&(K=n.RG32UI),G===n.BYTE&&(K=n.RG8I),G===n.SHORT&&(K=n.RG16I),G===n.INT&&(K=n.RG32I)),b===n.RGB_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RGB8UI),G===n.UNSIGNED_SHORT&&(K=n.RGB16UI),G===n.UNSIGNED_INT&&(K=n.RGB32UI),G===n.BYTE&&(K=n.RGB8I),G===n.SHORT&&(K=n.RGB16I),G===n.INT&&(K=n.RGB32I)),b===n.RGBA_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RGBA8UI),G===n.UNSIGNED_SHORT&&(K=n.RGBA16UI),G===n.UNSIGNED_INT&&(K=n.RGBA32UI),G===n.BYTE&&(K=n.RGBA8I),G===n.SHORT&&(K=n.RGBA16I),G===n.INT&&(K=n.RGBA32I)),b===n.RGB&&(G===n.UNSIGNED_SHORT&&at&&(K=at.RGB16_EXT),G===n.SHORT&&at&&(K=at.RGB16_SNORM_EXT),G===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),G===n.UNSIGNED_INT_10F_11F_11F_REV&&(K=n.R11F_G11F_B10F)),b===n.RGBA){let et=rt?er:jt.getTransfer(J);G===n.FLOAT&&(K=n.RGBA32F),G===n.HALF_FLOAT&&(K=n.RGBA16F),G===n.UNSIGNED_BYTE&&(K=et===ne?n.SRGB8_ALPHA8:n.RGBA8),G===n.UNSIGNED_SHORT&&at&&(K=at.RGBA16_EXT),G===n.SHORT&&at&&(K=at.RGBA16_SNORM_EXT),G===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),G===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function M(P,b){let G;return P?b===null||b===wn||b===Ls?G=n.DEPTH24_STENCIL8:b===En?G=n.DEPTH32F_STENCIL8:b===Ds&&(G=n.DEPTH24_STENCIL8,Lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===wn||b===Ls?G=n.DEPTH_COMPONENT24:b===En?G=n.DEPTH_COMPONENT32F:b===Ds&&(G=n.DEPTH_COMPONENT16),G}function S(P,b){return f(P)===!0||P.isFramebufferTexture&&P.minFilter!==Re&&P.minFilter!==De?Math.log2(Math.max(b.width,b.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?b.mipmaps.length:1}function w(P){let b=P.target;b.removeEventListener("dispose",w),T(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&d.delete(b)}function x(P){let b=P.target;b.removeEventListener("dispose",x),D(b)}function T(P){let b=i.get(P);if(b.__webglInit===void 0)return;let G=P.source,W=p.get(G);if(W){let J=W[b.__cacheKey];J.usedTimes--,J.usedTimes===0&&I(P),Object.keys(W).length===0&&p.delete(G)}i.remove(P)}function I(P){let b=i.get(P);n.deleteTexture(b.__webglTexture);let G=P.source,W=p.get(G);delete W[b.__cacheKey],a.memory.textures--}function D(P){let b=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(b.__webglFramebuffer[W]))for(let J=0;J<b.__webglFramebuffer[W].length;J++)n.deleteFramebuffer(b.__webglFramebuffer[W][J]);else n.deleteFramebuffer(b.__webglFramebuffer[W]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[W])}else{if(Array.isArray(b.__webglFramebuffer))for(let W=0;W<b.__webglFramebuffer.length;W++)n.deleteFramebuffer(b.__webglFramebuffer[W]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let W=0;W<b.__webglColorRenderbuffer.length;W++)b.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[W]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let G=P.textures;for(let W=0,J=G.length;W<J;W++){let rt=i.get(G[W]);rt.__webglTexture&&(n.deleteTexture(rt.__webglTexture),a.memory.textures--),i.remove(G[W])}i.remove(P)}let R=0;function B(){R=0}function C(){return R}function U(P){R=P}function F(){let P=R;return P>=s.maxTextures&&Lt("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+s.maxTextures),R+=1,P}function L(P){let b=[];return b.push(P.wrapS),b.push(P.wrapT),b.push(P.wrapR||0),b.push(P.magFilter),b.push(P.minFilter),b.push(P.anisotropy),b.push(P.internalFormat),b.push(P.format),b.push(P.type),b.push(P.generateMipmaps),b.push(P.premultiplyAlpha),b.push(P.flipY),b.push(P.unpackAlignment),b.push(P.colorSpace),b.join()}function O(P,b){let G=i.get(P);if(P.isVideoTexture&&N(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&G.__version!==P.version){let W=P.image;if(W===null)Lt("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Lt("WebGLRenderer: Texture marked for update but image is incomplete");else{dt(G,P,b);return}}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,G.__webglTexture,n.TEXTURE0+b)}function X(P,b){let G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){dt(G,P,b);return}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,G.__webglTexture,n.TEXTURE0+b)}function Z(P,b){let G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){dt(G,P,b);return}e.bindTexture(n.TEXTURE_3D,G.__webglTexture,n.TEXTURE0+b)}function Q(P,b){let G=i.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&G.__version!==P.version){xt(G,P,b);return}e.bindTexture(n.TEXTURE_CUBE_MAP,G.__webglTexture,n.TEXTURE0+b)}let it={[Xa]:n.REPEAT,[Fn]:n.CLAMP_TO_EDGE,[qa]:n.MIRRORED_REPEAT},It={[Re]:n.NEAREST,[vf]:n.NEAREST_MIPMAP_NEAREST,[Ar]:n.NEAREST_MIPMAP_LINEAR,[De]:n.LINEAR,[Eo]:n.LINEAR_MIPMAP_NEAREST,[Ci]:n.LINEAR_MIPMAP_LINEAR},Ot={[Sf]:n.NEVER,[Cf]:n.ALWAYS,[wf]:n.LESS,[ll]:n.LEQUAL,[Ef]:n.EQUAL,[cl]:n.GEQUAL,[Tf]:n.GREATER,[Af]:n.NOTEQUAL};function Nt(P,b){if(b.type===En&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===De||b.magFilter===Eo||b.magFilter===Ar||b.magFilter===Ci||b.minFilter===De||b.minFilter===Eo||b.minFilter===Ar||b.minFilter===Ci)&&Lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(P,n.TEXTURE_WRAP_S,it[b.wrapS]),n.texParameteri(P,n.TEXTURE_WRAP_T,it[b.wrapT]),(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)&&n.texParameteri(P,n.TEXTURE_WRAP_R,it[b.wrapR]),n.texParameteri(P,n.TEXTURE_MAG_FILTER,It[b.magFilter]),n.texParameteri(P,n.TEXTURE_MIN_FILTER,It[b.minFilter]),b.compareFunction&&(n.texParameteri(P,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(P,n.TEXTURE_COMPARE_FUNC,Ot[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===Re||b.minFilter!==Ar&&b.minFilter!==Ci||b.type===En&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let G=t.get("EXT_texture_filter_anisotropic");n.texParameterf(P,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function z(P,b){let G=!1;P.__webglInit===void 0&&(P.__webglInit=!0,b.addEventListener("dispose",w));let W=b.source,J=p.get(W);J===void 0&&(J={},p.set(W,J));let rt=L(b);if(rt!==P.__cacheKey){J[rt]===void 0&&(J[rt]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,G=!0),J[rt].usedTimes++;let at=J[P.__cacheKey];at!==void 0&&(J[P.__cacheKey].usedTimes--,at.usedTimes===0&&I(b)),P.__cacheKey=rt,P.__webglTexture=J[rt].texture}return G}function tt(P,b,G){return Math.floor(Math.floor(P/G)/b)}function j(P,b,G,W){let rt=P.updateRanges;if(rt.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,b.width,b.height,G,W,b.data);else{rt.sort((Tt,ut)=>Tt.start-ut.start);let at=0;for(let Tt=1;Tt<rt.length;Tt++){let ut=rt[at],ot=rt[Tt],Dt=ut.start+ut.count,Ft=tt(ot.start,b.width,4),Wt=tt(ut.start,b.width,4);ot.start<=Dt+1&&Ft===Wt&&tt(ot.start+ot.count-1,b.width,4)===Ft?ut.count=Math.max(ut.count,ot.start+ot.count-ut.start):(++at,rt[at]=ot)}rt.length=at+1;let K=e.getParameter(n.UNPACK_ROW_LENGTH),et=e.getParameter(n.UNPACK_SKIP_PIXELS),lt=e.getParameter(n.UNPACK_SKIP_ROWS);e.pixelStorei(n.UNPACK_ROW_LENGTH,b.width);for(let Tt=0,ut=rt.length;Tt<ut;Tt++){let ot=rt[Tt],Dt=Math.floor(ot.start/4),Ft=Math.ceil(ot.count/4),Wt=Dt%b.width,k=Math.floor(Dt/b.width),ht=Ft,nt=1;e.pixelStorei(n.UNPACK_SKIP_PIXELS,Wt),e.pixelStorei(n.UNPACK_SKIP_ROWS,k),e.texSubImage2D(n.TEXTURE_2D,0,Wt,k,ht,nt,G,W,b.data)}P.clearUpdateRanges(),e.pixelStorei(n.UNPACK_ROW_LENGTH,K),e.pixelStorei(n.UNPACK_SKIP_PIXELS,et),e.pixelStorei(n.UNPACK_SKIP_ROWS,lt)}}function dt(P,b,G){let W=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&(W=n.TEXTURE_3D);let J=z(P,b),rt=b.source;e.bindTexture(W,P.__webglTexture,n.TEXTURE0+G);let at=i.get(rt);if(rt.version!==at.__version||J===!0){if(e.activeTexture(n.TEXTURE0+G),(typeof ImageBitmap!="undefined"&&b.image instanceof ImageBitmap)===!1){let nt=jt.getPrimaries(jt.workingColorSpace),ft=b.colorSpace===ni?null:jt.getPrimaries(b.colorSpace),_t=b.colorSpace===ni||nt===ft?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,_t)}e.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment);let et=m(b.image,!1,s.maxTextureSize);et=ct(b,et);let lt=r.convert(b.format,b.colorSpace),Tt=r.convert(b.type),ut=_(b.internalFormat,lt,Tt,b.normalized,b.colorSpace,b.isVideoTexture);Nt(W,b);let ot,Dt=b.mipmaps,Ft=b.isVideoTexture!==!0,Wt=at.__version===void 0||J===!0,k=rt.dataReady,ht=S(b,et);if(b.isDepthTexture)ut=M(b.format===Ri,b.type),Wt&&(Ft?e.texStorage2D(n.TEXTURE_2D,1,ut,et.width,et.height):e.texImage2D(n.TEXTURE_2D,0,ut,et.width,et.height,0,lt,Tt,null));else if(b.isDataTexture)if(Dt.length>0){Ft&&Wt&&e.texStorage2D(n.TEXTURE_2D,ht,ut,Dt[0].width,Dt[0].height);for(let nt=0,ft=Dt.length;nt<ft;nt++)ot=Dt[nt],Ft?k&&e.texSubImage2D(n.TEXTURE_2D,nt,0,0,ot.width,ot.height,lt,Tt,ot.data):e.texImage2D(n.TEXTURE_2D,nt,ut,ot.width,ot.height,0,lt,Tt,ot.data);b.generateMipmaps=!1}else Ft?(Wt&&e.texStorage2D(n.TEXTURE_2D,ht,ut,et.width,et.height),k&&j(b,et,lt,Tt)):e.texImage2D(n.TEXTURE_2D,0,ut,et.width,et.height,0,lt,Tt,et.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){Ft&&Wt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ht,ut,Dt[0].width,Dt[0].height,et.depth);for(let nt=0,ft=Dt.length;nt<ft;nt++)if(ot=Dt[nt],b.format!==un)if(lt!==null)if(Ft){if(k)if(b.layerUpdates.size>0){let _t=rh(ot.width,ot.height,b.format,b.type);for(let st of b.layerUpdates){let At=ot.data.subarray(st*_t/ot.data.BYTES_PER_ELEMENT,(st+1)*_t/ot.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,nt,0,0,st,ot.width,ot.height,1,lt,At)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,nt,0,0,0,ot.width,ot.height,et.depth,lt,ot.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,nt,ut,ot.width,ot.height,et.depth,0,ot.data,0,0);else Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ft?k&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,nt,0,0,0,ot.width,ot.height,et.depth,lt,Tt,ot.data):e.texImage3D(n.TEXTURE_2D_ARRAY,nt,ut,ot.width,ot.height,et.depth,0,lt,Tt,ot.data)}else{Ft&&Wt&&e.texStorage2D(n.TEXTURE_2D,ht,ut,Dt[0].width,Dt[0].height);for(let nt=0,ft=Dt.length;nt<ft;nt++)ot=Dt[nt],b.format!==un?lt!==null?Ft?k&&e.compressedTexSubImage2D(n.TEXTURE_2D,nt,0,0,ot.width,ot.height,lt,ot.data):e.compressedTexImage2D(n.TEXTURE_2D,nt,ut,ot.width,ot.height,0,ot.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ft?k&&e.texSubImage2D(n.TEXTURE_2D,nt,0,0,ot.width,ot.height,lt,Tt,ot.data):e.texImage2D(n.TEXTURE_2D,nt,ut,ot.width,ot.height,0,lt,Tt,ot.data)}else if(b.isDataArrayTexture)if(Ft){if(Wt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ht,ut,et.width,et.height,et.depth),k)if(b.layerUpdates.size>0){let nt=rh(et.width,et.height,b.format,b.type);for(let ft of b.layerUpdates){let _t=et.data.subarray(ft*nt/et.data.BYTES_PER_ELEMENT,(ft+1)*nt/et.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ft,et.width,et.height,1,lt,Tt,_t)}b.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,et.width,et.height,et.depth,lt,Tt,et.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,ut,et.width,et.height,et.depth,0,lt,Tt,et.data);else if(b.isData3DTexture)Ft?(Wt&&e.texStorage3D(n.TEXTURE_3D,ht,ut,et.width,et.height,et.depth),k&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,et.width,et.height,et.depth,lt,Tt,et.data)):e.texImage3D(n.TEXTURE_3D,0,ut,et.width,et.height,et.depth,0,lt,Tt,et.data);else if(b.isFramebufferTexture){if(Wt)if(Ft)e.texStorage2D(n.TEXTURE_2D,ht,ut,et.width,et.height);else{let nt=et.width,ft=et.height;for(let _t=0;_t<ht;_t++)e.texImage2D(n.TEXTURE_2D,_t,ut,nt,ft,0,lt,Tt,null),nt>>=1,ft>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in n){let nt=n.canvas;if(nt.hasAttribute("layoutsubtree")||nt.setAttribute("layoutsubtree","true"),et.parentNode!==nt){nt.appendChild(et),d.add(b),nt.onpaint=ft=>{let _t=ft.changedElements;for(let st of d)_t.includes(st.image)&&(st.needsUpdate=!0)},nt.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,et);else{let _t=n.RGBA,st=n.RGBA,At=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,_t,st,At,et)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Dt.length>0){if(Ft&&Wt){let nt=yt(Dt[0]);e.texStorage2D(n.TEXTURE_2D,ht,ut,nt.width,nt.height)}for(let nt=0,ft=Dt.length;nt<ft;nt++)ot=Dt[nt],Ft?k&&e.texSubImage2D(n.TEXTURE_2D,nt,0,0,lt,Tt,ot):e.texImage2D(n.TEXTURE_2D,nt,ut,lt,Tt,ot);b.generateMipmaps=!1}else if(Ft){if(Wt){let nt=yt(et);e.texStorage2D(n.TEXTURE_2D,ht,ut,nt.width,nt.height)}k&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,lt,Tt,et)}else e.texImage2D(n.TEXTURE_2D,0,ut,lt,Tt,et);f(b)&&v(W),at.__version=rt.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function xt(P,b,G){if(b.image.length!==6)return;let W=z(P,b),J=b.source;e.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+G);let rt=i.get(J);if(J.version!==rt.__version||W===!0){e.activeTexture(n.TEXTURE0+G);let at=jt.getPrimaries(jt.workingColorSpace),K=b.colorSpace===ni?null:jt.getPrimaries(b.colorSpace),et=b.colorSpace===ni||at===K?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),e.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,et);let lt=b.isCompressedTexture||b.image[0].isCompressedTexture,Tt=b.image[0]&&b.image[0].isDataTexture,ut=[];for(let st=0;st<6;st++)!lt&&!Tt?ut[st]=m(b.image[st],!0,s.maxCubemapSize):ut[st]=Tt?b.image[st].image:b.image[st],ut[st]=ct(b,ut[st]);let ot=ut[0],Dt=r.convert(b.format,b.colorSpace),Ft=r.convert(b.type),Wt=_(b.internalFormat,Dt,Ft,b.normalized,b.colorSpace),k=b.isVideoTexture!==!0,ht=rt.__version===void 0||W===!0,nt=J.dataReady,ft=S(b,ot);Nt(n.TEXTURE_CUBE_MAP,b);let _t;if(lt){k&&ht&&e.texStorage2D(n.TEXTURE_CUBE_MAP,ft,Wt,ot.width,ot.height);for(let st=0;st<6;st++){_t=ut[st].mipmaps;for(let At=0;At<_t.length;At++){let wt=_t[At];b.format!==un?Dt!==null?k?nt&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,0,0,wt.width,wt.height,Dt,wt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,Wt,wt.width,wt.height,0,wt.data):Lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):k?nt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,0,0,wt.width,wt.height,Dt,Ft,wt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At,Wt,wt.width,wt.height,0,Dt,Ft,wt.data)}}}else{if(_t=b.mipmaps,k&&ht){_t.length>0&&ft++;let st=yt(ut[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,ft,Wt,st.width,st.height)}for(let st=0;st<6;st++)if(Tt){k?nt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,ut[st].width,ut[st].height,Dt,Ft,ut[st].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Wt,ut[st].width,ut[st].height,0,Dt,Ft,ut[st].data);for(let At=0;At<_t.length;At++){let me=_t[At].image[st].image;k?nt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,0,0,me.width,me.height,Dt,Ft,me.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,Wt,me.width,me.height,0,Dt,Ft,me.data)}}else{k?nt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,0,0,Dt,Ft,ut[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,0,Wt,Dt,Ft,ut[st]);for(let At=0;At<_t.length;At++){let wt=_t[At];k?nt&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,0,0,Dt,Ft,wt.image[st]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+st,At+1,Wt,Dt,Ft,wt.image[st])}}}f(b)&&v(n.TEXTURE_CUBE_MAP),rt.__version=J.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function vt(P,b,G,W,J,rt){let at=r.convert(G.format,G.colorSpace),K=r.convert(G.type),et=_(G.internalFormat,at,K,G.normalized,G.colorSpace),lt=i.get(b),Tt=i.get(G);if(Tt.__renderTarget=b,!lt.__hasExternalTextures){let ut=Math.max(1,b.width>>rt),ot=Math.max(1,b.height>>rt);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?e.texImage3D(J,rt,et,ut,ot,b.depth,0,at,K,null):e.texImage2D(J,rt,et,ut,ot,0,at,K,null)}e.bindFramebuffer(n.FRAMEBUFFER,P),xe(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,J,Tt.__webglTexture,0,te(b)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,J,Tt.__webglTexture,rt),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Zt(P,b,G){if(n.bindRenderbuffer(n.RENDERBUFFER,P),b.depthBuffer){let W=b.depthTexture,J=W&&W.isDepthTexture?W.type:null,rt=M(b.stencilBuffer,J),at=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;xe(b)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,te(b),rt,b.width,b.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,te(b),rt,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,rt,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,at,n.RENDERBUFFER,P)}else{let W=b.textures;for(let J=0;J<W.length;J++){let rt=W[J],at=r.convert(rt.format,rt.colorSpace),K=r.convert(rt.type),et=_(rt.internalFormat,at,K,rt.normalized,rt.colorSpace);xe(b)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,te(b),et,b.width,b.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,te(b),et,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,et,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function zt(P,b,G){let W=b.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,P),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=i.get(b.depthTexture);if(J.__renderTarget=b,(!J.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),W){if(J.__webglInit===void 0&&(J.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),Nt(n.TEXTURE_CUBE_MAP,b.depthTexture);let lt=r.convert(b.depthTexture.format),Tt=r.convert(b.depthTexture.type),ut;b.depthTexture.format===On?ut=n.DEPTH_COMPONENT24:b.depthTexture.format===Ri&&(ut=n.DEPTH24_STENCIL8);for(let ot=0;ot<6;ot++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ot,0,ut,b.width,b.height,0,lt,Tt,null)}}else O(b.depthTexture,0);let rt=J.__webglTexture,at=te(b),K=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+G:n.TEXTURE_2D,et=b.depthTexture.format===Ri?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(b.depthTexture.format===On)xe(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,et,K,rt,0,at):n.framebufferTexture2D(n.FRAMEBUFFER,et,K,rt,0);else if(b.depthTexture.format===Ri)xe(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,et,K,rt,0,at):n.framebufferTexture2D(n.FRAMEBUFFER,et,K,rt,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function Ht(P){let b=i.get(P),G=P.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==P.depthTexture){let W=P.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),W){let J=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),b.__depthDisposeCallback=J}b.__boundDepthTexture=W}if(P.depthTexture&&!b.__autoAllocateDepthBuffer)if(G)for(let W=0;W<6;W++)zt(b.__webglFramebuffer[W],P,W);else{let W=P.texture.mipmaps;W&&W.length>0?zt(b.__webglFramebuffer[0],P,0):zt(b.__webglFramebuffer,P,0)}else if(G){b.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[W]),b.__webglDepthbuffer[W]===void 0)b.__webglDepthbuffer[W]=n.createRenderbuffer(),Zt(b.__webglDepthbuffer[W],P,!1);else{let J=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,rt=b.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,rt),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,rt)}}else{let W=P.texture.mipmaps;if(W&&W.length>0?e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),Zt(b.__webglDepthbuffer,P,!1);else{let J=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,rt=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,rt),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,rt)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function kt(P,b,G){let W=i.get(P);b!==void 0&&vt(W.__webglFramebuffer,P,P.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),G!==void 0&&Ht(P)}function Gt(P){let b=P.texture,G=i.get(P),W=i.get(b);P.addEventListener("dispose",x);let J=P.textures,rt=P.isWebGLCubeRenderTarget===!0,at=J.length>1;if(at||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=b.version,a.memory.textures++),rt){G.__webglFramebuffer=[];for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0){G.__webglFramebuffer[K]=[];for(let et=0;et<b.mipmaps.length;et++)G.__webglFramebuffer[K][et]=n.createFramebuffer()}else G.__webglFramebuffer[K]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){G.__webglFramebuffer=[];for(let K=0;K<b.mipmaps.length;K++)G.__webglFramebuffer[K]=n.createFramebuffer()}else G.__webglFramebuffer=n.createFramebuffer();if(at)for(let K=0,et=J.length;K<et;K++){let lt=i.get(J[K]);lt.__webglTexture===void 0&&(lt.__webglTexture=n.createTexture(),a.memory.textures++)}if(P.samples>0&&xe(P)===!1){G.__webglMultisampledFramebuffer=n.createFramebuffer(),G.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let K=0;K<J.length;K++){let et=J[K];G.__webglColorRenderbuffer[K]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,G.__webglColorRenderbuffer[K]);let lt=r.convert(et.format,et.colorSpace),Tt=r.convert(et.type),ut=_(et.internalFormat,lt,Tt,et.normalized,et.colorSpace,P.isXRRenderTarget===!0),ot=te(P);n.renderbufferStorageMultisample(n.RENDERBUFFER,ot,ut,P.width,P.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+K,n.RENDERBUFFER,G.__webglColorRenderbuffer[K])}n.bindRenderbuffer(n.RENDERBUFFER,null),P.depthBuffer&&(G.__webglDepthRenderbuffer=n.createRenderbuffer(),Zt(G.__webglDepthRenderbuffer,P,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(rt){e.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),Nt(n.TEXTURE_CUBE_MAP,b);for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)vt(G.__webglFramebuffer[K][et],P,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,et);else vt(G.__webglFramebuffer[K],P,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0);f(b)&&v(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(at){for(let K=0,et=J.length;K<et;K++){let lt=J[K],Tt=i.get(lt),ut=n.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(ut=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(ut,Tt.__webglTexture),Nt(ut,lt),vt(G.__webglFramebuffer,P,lt,n.COLOR_ATTACHMENT0+K,ut,0),f(lt)&&v(ut)}e.unbindTexture()}else{let K=n.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(K=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(K,W.__webglTexture),Nt(K,b),b.mipmaps&&b.mipmaps.length>0)for(let et=0;et<b.mipmaps.length;et++)vt(G.__webglFramebuffer[et],P,b,n.COLOR_ATTACHMENT0,K,et);else vt(G.__webglFramebuffer,P,b,n.COLOR_ATTACHMENT0,K,0);f(b)&&v(K),e.unbindTexture()}P.depthBuffer&&Ht(P)}function Mt(P){let b=P.textures;for(let G=0,W=b.length;G<W;G++){let J=b[G];if(f(J)){let rt=E(P),at=i.get(J).__webglTexture;e.bindTexture(rt,at),v(rt),e.unbindTexture()}}}let Bt=[],Kt=[];function ee(P){if(P.samples>0){if(xe(P)===!1){let b=P.textures,G=P.width,W=P.height,J=n.COLOR_BUFFER_BIT,rt=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,at=i.get(P),K=b.length>1;if(K)for(let lt=0;lt<b.length;lt++)e.bindFramebuffer(n.FRAMEBUFFER,at.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+lt,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,at.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+lt,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,at.__webglMultisampledFramebuffer);let et=P.texture.mipmaps;et&&et.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,at.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,at.__webglFramebuffer);for(let lt=0;lt<b.length;lt++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),K){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,at.__webglColorRenderbuffer[lt]);let Tt=i.get(b[lt]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Tt,0)}n.blitFramebuffer(0,0,G,W,0,0,G,W,J,n.NEAREST),c===!0&&(Bt.length=0,Kt.length=0,Bt.push(n.COLOR_ATTACHMENT0+lt),P.depthBuffer&&P.resolveDepthBuffer===!1&&(Bt.push(rt),Kt.push(rt),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,Kt)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Bt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),K)for(let lt=0;lt<b.length;lt++){e.bindFramebuffer(n.FRAMEBUFFER,at.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+lt,n.RENDERBUFFER,at.__webglColorRenderbuffer[lt]);let Tt=i.get(b[lt]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,at.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+lt,n.TEXTURE_2D,Tt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,at.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&c){let b=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function te(P){return Math.min(s.maxSamples,P.samples)}function xe(P){let b=i.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function N(P){let b=a.render.frame;h.get(P)!==b&&(h.set(P,b),P.update())}function ct(P,b){let G=P.colorSpace,W=P.format,J=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||G!==tr&&G!==ni&&(jt.getTransfer(G)===ne?(W!==un||J!==on)&&Lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ut("WebGLTextures: Unsupported texture color space:",G)),b}function yt(P){return typeof HTMLImageElement!="undefined"&&P instanceof HTMLImageElement?(l.width=P.naturalWidth||P.width,l.height=P.naturalHeight||P.height):typeof VideoFrame!="undefined"&&P instanceof VideoFrame?(l.width=P.displayWidth,l.height=P.displayHeight):(l.width=P.width,l.height=P.height),l}this.allocateTextureUnit=F,this.resetTextureUnits=B,this.getTextureUnits=C,this.setTextureUnits=U,this.setTexture2D=O,this.setTexture2DArray=X,this.setTexture3D=Z,this.setTextureCube=Q,this.rebindTextures=kt,this.setupRenderTarget=Gt,this.updateRenderTargetMipmap=Mt,this.updateMultisampleRenderTarget=ee,this.setupDepthRenderbuffer=Ht,this.setupFrameBufferTexture=vt,this.useMultisampledRTT=xe,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function tb(n,t){function e(i,s=ni){let r,a=jt.getTransfer(s);if(i===on)return n.UNSIGNED_BYTE;if(i===Ao)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Co)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Yc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Zc)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Xc)return n.BYTE;if(i===qc)return n.SHORT;if(i===Ds)return n.UNSIGNED_SHORT;if(i===To)return n.INT;if(i===wn)return n.UNSIGNED_INT;if(i===En)return n.FLOAT;if(i===Vn)return n.HALF_FLOAT;if(i===$c)return n.ALPHA;if(i===Jc)return n.RGB;if(i===un)return n.RGBA;if(i===On)return n.DEPTH_COMPONENT;if(i===Ri)return n.DEPTH_STENCIL;if(i===Kc)return n.RED;if(i===Ro)return n.RED_INTEGER;if(i===Ii)return n.RG;if(i===Io)return n.RG_INTEGER;if(i===Po)return n.RGBA_INTEGER;if(i===Cr||i===Rr||i===Ir||i===Pr)if(a===ne)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Cr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ir)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Pr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Cr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Rr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ir)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Pr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Do||i===Lo||i===No||i===Uo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Do)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===No)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Fo||i===Oo||i===Bo||i===zo||i===ko||i===Dr||i===Vo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Fo||i===Oo)return a===ne?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Bo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===zo)return r.COMPRESSED_R11_EAC;if(i===ko)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Dr)return r.COMPRESSED_RG11_EAC;if(i===Vo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Go||i===Ho||i===Wo||i===Xo||i===qo||i===Yo||i===Zo||i===$o||i===Jo||i===Ko||i===jo||i===Qo||i===tl||i===el)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Go)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ho)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Wo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===$o)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Jo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ko)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qo)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===tl)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===el)return a===ne?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nl||i===il||i===sl)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===nl)return a===ne?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===il)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===sl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===rl||i===al||i===Lr||i===ol)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===rl)return r.COMPRESSED_RED_RGTC1_EXT;if(i===al)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ol)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ls?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}var eb=`
void main() {
