...
var SemanticGraphView = class extends import_obsidian.ItemView {
  constructor(leaf, plugin) {
    ...
    // zoom at which labels reach full opacity
  ...
  async loadSettings() {
    ...
    this.selectedDomain = (_b = s.selectedDomain) != null ? _b : null;
  }
  saveSettings() {
    const s = {
      ...
      sidebar.querySelectorAll("[data-physics]").forEach((input) => {
        input.addEventListener("input", () => {
          ...
          if (key === "linkDist") {
            ...
            const t = this.zoomBehavior.transform(svg);
            const k = t.k;
  ...
  buildSidebar(sidebar, A, adj) {
    ...
    mkSlider("Labels fade", "labelFadeAt", 0.1, 3, this.labelFadeAt, 0.05);
