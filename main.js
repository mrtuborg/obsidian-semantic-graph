...
var SemanticGraphView = class extends import_obsidian.ItemView {
  ...
  render() {
    ...
    const BASE_STROKE = 1;
    const BASE_ARROW_W = 8;
    const BASE_ARROW_H = 6;
    const BASE_NODE = 1;
    this.zoomBehavior = zoom_default2().scaleExtent([0.05, 10]).on("zoom", (ev) => {
      ...
      (_a2 = svgEl.querySelector("#llm-arrow")) == null ? void 0 : _a2.setAttribute("markerWidth", String(BASE_ARROW_W / k));
      (_b2 = svgEl.querySelector("#llm-arrow")) == null ? void 0 : _b2.setAttribute("markerHeight", String(BASE_ARROW_H / k));
    });
    ...
    svg.append("defs").append("marker").attr("id", "llm-arrow").attr("viewBox", "0 -3 6 6").attr("refX", 10).attr("refY", 0).attr("markerWidth", BASE_ARROW_W).attr("markerHeight", BASE_ARROW_H).attr("markerUnits", "userSpaceOnUse").attr("orient", "auto").append("path").attr("d", "M0,-3L6,0L0,3").attr("fill", "var(--text-faint)");
