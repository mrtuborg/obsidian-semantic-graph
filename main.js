...
var SemanticGraphView = class extends import_obsidian.ItemView {
  ...
  render() {
    ...
    for (const t of presentTypes) {
      ...
      pill.style.setProperty("--pill-color", (_a = NODE_COLORS[t]) != null ? _a : "#888");
    ...
    this.zoomBehavior = zoom_default2().scaleExtent([0.05, 10]).on("zoom", (ev) => g.attr("transform", ev.transform));
