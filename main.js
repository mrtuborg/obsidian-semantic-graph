...
var SemanticGraphView = class extends import_obsidian.ItemView {
  ...
  async loadSettings() {
    ...
    this.selectedDomains = new Set((_c = s.selectedDomains) != null ? _c : []);
