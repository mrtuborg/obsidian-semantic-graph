...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:kn,depthTest:!1,depthWrite:!1})}function fy(n,t,e){let i=new Float32Array($i),s=new k(0,1,0);return new rn({name:"SphericalGaussianBlur",defines:{n:$i,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/e,CUBEUV_MAX_MIP:`${n}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:ml(),fragmentShader:`
...
`)}var pv={[Oc]:"Linear",[Bc]:"Reinhard",[zc]:"Cineon",[kc]:"ACESFilmic",[Gc]:"AgX",[Hc]:"Neutral",[Vc]:"Custom"};function mv(n,t){let e=pv[t];return e===void 0?(Ft("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+n+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+n+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}var ul=new k;function gv(){Kt.getLuminanceCoefficients(ul);let n=ul.x.toFixed(4),t=ul.y.toFixed(4),e=ul.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${n}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);let E=v+m+a,_=v+f+o,M=Zf(s,s.VERTEX_SHADER,E),S=Zf(s,s.FRAGMENT_SHADER,_);s.attachShader(y,M),s.attachShader(y,S),e.index0AttributeName!==void 0?s.bindAttribLocation(y,0,e.index0AttributeName):e.hasPositionAttribute===!0&&s.bindAttribLocation(y,0,"position"),s.linkProgram(y);function w(D){if(n.debug.checkShaderErrors){let I=s.getProgramInfoLog(y)||"",O=s.getShaderInfoLog(M)||"",C=s.getShaderInfoLog(S)||"",N=I.trim(),U=O.trim(),L=C.trim(),B=!0,H=!0;if(s.getProgramParameter(y,s.LINK_STATUS)===!1)if(B=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(s,y,M,S);else{let Y=Jf(s,M,"vertex"),tt=Jf(s,S,"fragment");Ot("WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(y,s.VALIDATE_STATUS)+`
...
}`,$v=[new k(1,0,0),new k(-1,0,0),new k(0,1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1)],Jv=[new k(0,-1,0),new k(0,-1,0),new k(0,0,1),new k(0,0,-1),new k(0,-1,0),new k(0,-1,0)],sd=new de,Ur=new k,gh=new k;function Kv(n,t,e){let i=new ur,s=new Dt,r=new Dt,a=new pe,o=new ao,c=new oo,l={},h=e.maxTextureSize,d={[Qn]:We,[We]:Qn,[zn]:zn},u=new rn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Dt},radius:{value:4}},vertexShader:Yv,fragmentShader:Zv}),p=u.clone();p.defines.HORIZONTAL_PASS=1;let g=new Me;g.setAttribute("position",new Ye(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));let y=new He(g,u),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Er;let f=this.type;this.render=function(S,w,x){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||S.length===0)return;this.type===ju&&(Ft("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Er);let T=n.getRenderTarget(),R=n.getActiveCubeFace(),D=n.getActiveMipmapLevel(),I=n.state;I.setBlending(kn),I.buffers.depth.getReversed()===!0?I.buffers.color.setClear(0,0,0,0):I.buffers.color.setClear(1,1,1,1),I.buffers.depth.setTest(!0),I.setScissorTest(!1);let O=f!==this.type;O&&w.traverse(function(C){C.material&&(Array.isArray(C.material)?C.material.forEach(N=>N.needsUpdate=!0):C.material.needsUpdate=!0)});for(let C=0,N=S.length;C<N;C++){let U=S[C],L=U.shadow;if(L===void 0){Ft("WebGLShadowMap:",U,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;s.copy(L.mapSize);let B=L.getFrameExtents();s.multiply(B),r.copy(L.mapSize),(s.x>h||s.y>h)&&(s.x>h&&(r.x=Math.floor(h/B.x),s.x=r.x*B.x,L.mapSize.x=r.x),s.y>h&&(r.y=Math.floor(h/B.y),s.y=r.y*B.y,L.mapSize.y=r.y));let H=n.state.buffers.depth.getReversed();if(L.camera._reversedDepth=H,L.map===null||O===!0){if(L.map!==null&&(L.map.depthTexture!==null&&(L.map.depthTexture.dispose(),L.map.depthTexture=null),L.map.dispose()),this.type===Ps){if(U.isPointLight){Ft("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}L.map=new sn(s.x,s.y,{format:Ii,type:Vn,minFilter:De,magFilter:De,generateMipmaps:!1}),L.map.texture.name=U.name+".shadowMap",L.map.depthTexture=new ei(s.x,s.y,En),L.map.depthTexture.name=U.name+".shadowMapDepth",L.map.depthTexture.format=On,L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Re,L.map.depthTexture.magFilter=Re}else U.isPointLight?(L.map=new dl(s.x),L.map.depthTexture=new io(s.x,wn)):(L.map=new sn(s.x,s.y),L.map.depthTexture=new ei(s.x,s.y,wn)),L.map.depthTexture.name=U.name+".shadowMap",L.map.depthTexture.format=On,this.type===Er?(L.map.depthTexture.compareFunction=H?cl:ll,L.map.depthTexture.minFilter=De,L.map.depthTexture.magFilter=De):(L.map.depthTexture.compareFunction=null,L.map.depthTexture.minFilter=Re,L.map.depthTexture.magFilter=Re);L.camera.updateProjectionMatrix()}let Y=L.map.isWebGLCubeRenderTarget?6:1;for(let tt=0;tt<Y;tt++){if(L.map.isWebGLCubeRenderTarget)n.setRenderTarget(L.map,tt),n.clear();else{tt===0&&(n.setRenderTarget(L.map),n.clear());let st=L.getViewport(tt);a.set(r.x*st.x,r.y*st.y,r.x*st.z,r.y*st.w),I.viewport(a)}if(U.isPointLight){let st=L.camera,Nt=L.matrix,nt=U.distance||st.far;nt!==st.far&&(st.far=nt,st.updateProjectionMatrix()),Ur.setFromMatrixPosition(U.matrixWorld),st.position.copy(Ur),gh.copy(st.position),gh.add($v[tt]),st.up.copy(Jv[tt]),st.lookAt(gh),st.updateMatrixWorld(),Nt.makeTranslation(-Ur.x,-Ur.y,-Ur.z),sd.multiplyMatrices(st.projectionMatrix,st.matrixWorldInverse),L._frustum.setFromProjectionMatrix(sd,st.coordinateSystem,st.reversedDepth)}else L.updateMatrices(U);i=L.getFrustum(),_(w,x,L.camera,U,this.type)}L.isPointLightShadow!==!0&&this.type===Ps&&v(L,x),L.needsUpdate=!1}f=this.type,m.needsUpdate=!1,n.setRenderTarget(T,R,D)};function v(S,w){let x=t.update(y);u.defines.VSM_SAMPLES!==S.blurSamples&&(u.defines.VSM_SAMPLES=S.blurSamples,p.defines.VSM_SAMPLES=S.blurSamples,u.needsUpdate=!0,p.needsUpdate=!0),S.mapPass===null&&(S.mapPass=new sn(s.x,s.y,{format:Ii,type:Vn})),u.uniforms.shadow_pass.value=S.map.depthTexture,u.uniforms.resolution.value=S.mapSize,u.uniforms.radius.value=S.radius,n.setRenderTarget(S.mapPass),n.clear(),n.renderBufferDirect(w,null,x,u,y,null),p.uniforms.shadow_pass.value=S.mapPass.texture,p.uniforms.resolution.value=S.mapSize,p.uniforms.radius.value=S.radius,n.setRenderTarget(S.map),n.clear(),n.renderBufferDirect(w,null,x,p,y,null)}function E(S,w,x,T){let R=null,D=x.isPointLight===!0?S.customDistanceMaterial:S.customDepthMaterial;if(D!==void 0)R=D;else if(R=x.isPointLight===!0?c:o,n.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){let I=R.uuid,O=w.uuid,C=l[I];C===void 0&&(C={},l[I]=C);let N=C[O];N===void 0&&(N=R.clone(),C[O]=N,w.addEventListener("dispose",M)),R=N}if(R.visible=w.visible,R.wireframe=w.wireframe,T===Ps?R.side=w.shadowSide!==null?w.shadowSide:w.side:R.side=w.shadowSide!==null?w.shadowSide:d[w.side],R.alphaMap=w.alphaMap,R.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,R.map=w.map,R.clipShadows=w.clipShadows,R.clippingPlanes=w.clippingPlanes,R.clipIntersection=w.clipIntersection,R.displacementMap=w.displacementMap,R.displacementScale=w.displacementScale,R.displacementBias=w.displacementBias,R.wireframeLinewidth=w.wireframeLinewidth,R.linewidth=w.linewidth,x.isPointLight===!0&&R.isMeshDistanceMaterial===!0){let I=n.properties.get(R);I.light=x}return R}function _(S,w,x,T,R){if(S.visible===!1)return;if(S.layers.test(w.layers)&&(S.isMesh||S.isLine||S.isPoints)&&(S.castShadow||S.receiveShadow&&R===Ps)&&(!S.frustumCulled||i.intersectsObject(S))){S.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,S.matrixWorld);let O=t.update(S),C=S.material;if(Array.isArray(C)){let N=O.groups;for(let U=0,L=N.length;U<L;U++){let B=N[U],H=C[B.materialIndex];if(H&&H.visible){let Y=E(S,H,T,R);S.onBeforeShadow(n,S,w,x,O,Y,B),n.renderBufferDirect(x,null,O,Y,S,B),S.onAfterShadow(n,S,w,x,O,Y,B)}}}else if(C.visible){let N=E(S,C,T,R);S.onBeforeShadow(n,S,w,x,O,N,null),n.renderBufferDirect(x,null,O,N,S,null),S.onAfterShadow(n,S,w,x,O,N,null)}}let I=S.children;for(let O=0,C=I.length;O<C;O++)_(I[O],w,x,T,R)}function M(S){S.target.removeEventListener("dispose",M);for(let x in l){let T=l[x],R=S.target.uuid;R in T&&(T[R].dispose(),delete T[R])}}}function jv(n,t){function e(){let z=!1,ft=new pe,et=null,pt=new pe(0,0,0,0);return{setMask:function(vt){et!==vt&&!z&&(n.colorMask(vt,vt,vt,vt),et=vt)},setLocked:function(vt){z=vt},setClear:function(vt,rt,It,Tt,me){me===!0&&(vt*=Tt,rt*=Tt,It*=Tt),ft.set(vt,rt,It,Tt),pt.equals(ft)===!1&&(n.clearColor(vt,rt,It,Tt),pt.copy(ft))},reset:function(){z=!1,et=null,pt.set(-1,0,0,0)}}}function i(){let z=!1,ft=!1,et=null,pt=null,vt=null;return{setReversed:function(rt){if(ft!==rt){let It=t.get("EXT_clip_control");rt?It.clipControlEXT(It.LOWER_LEFT_EXT,It.ZERO_TO_ONE_EXT):It.clipControlEXT(It.LOWER_LEFT_EXT,It.NEGATIVE_ONE_TO_ONE_EXT),ft=rt;let Tt=vt;vt=null,this.setClear(Tt)}},getReversed:function(){return ft},setTest:function(rt){rt?j(n.DEPTH_TEST):bt(n.DEPTH_TEST)},setMask:function(rt){et!==rt&&!z&&(n.depthMask(rt),et=rt)},setFunc:function(rt){if(ft&&(rt=Df[rt]),pt!==rt){switch(rt){case Ba:n.depthFunc(n.NEVER);break;case za:n.depthFunc(n.ALWAYS);break;case ka:n.depthFunc(n.LESS);break;case qi:n.depthFunc(n.LEQUAL);break;case Va:n.depthFunc(n.EQUAL);break;case Ga:n.depthFunc(n.GEQUAL);break;case Ha:n.depthFunc(n.GREATER);break;case Wa:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}pt=rt}},setLocked:function(rt){z=rt},setClear:function(rt){vt!==rt&&(vt=rt,ft&&(rt=1-rt),n.clearDepth(rt))},reset:function(){z=!1,et=null,pt=null,vt=null,ft=!1}}}function s(){let z=!1,ft=null,et=null,pt=null,vt=null,rt=null,It=null,Tt=null,me=null;return{setTest:function(ce){z||(ce?j(n.STENCIL_TEST):bt(n.STENCIL_TEST))},setMask:function(ce){ft!==ce&&!z&&(n.stencilMask(ce),ft=ce)},setFunc:function(ce,Dn,Ln){(et!==ce||pt!==Dn||vt!==Ln)&&(n.stencilFunc(ce,Dn,Ln),et=ce,pt=Dn,vt=Ln)},setOp:function(ce,Dn,Ln){(rt!==ce||It!==Dn||Tt!==Ln)&&(n.stencilOp(ce,Dn,Ln),rt=ce,It=Dn,Tt=Ln)},setLocked:function(ce){z=ce},setClear:function(ce){me!==ce&&(n.clearStencil(ce),me=ce)},reset:function(){z=!1,ft=null,et=null,pt=null,vt=null,rt=null,It=null,Tt=null,me=null}}}let r=new e,a=new i,o=new s,c=new WeakMap,l=new WeakMap,h={},d={},u={},p=new WeakMap,g=[],y=null,m=!1,f=null,v=null,E=null,_=null,M=null,S=null,w=null,x=new Zt(0,0,0),T=0,R=!1,D=null,I=null,O=null,C=null,N=null,U=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS),L=!1,B=0,H=n.getParameter(n.VERSION);H.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(H)[1]),L=B>=1):H.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(H)[1]),L=B>=2);let Y=null,tt={},st=n.getParameter(n.SCISSOR_BOX),Nt=n.getParameter(n.VIEWPORT),nt=new pe().fromArray(st),ht=new pe().fromArray(Nt);function X(z,ft,et,pt){let vt=new Uint8Array(4),rt=n.createTexture();n.bindTexture(z,rt),n.texParameteri(z,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(z,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let It=0;It<et;It++)z===n.TEXTURE_3D||z===n.TEXTURE_2D_ARRAY?n.texImage3D(ft,0,n.RGBA,1,1,pt,0,n.RGBA,n.UNSIGNED_BYTE,vt):n.texImage2D(ft+It,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,vt);return rt}let it={};it[n.TEXTURE_2D]=X(n.TEXTURE_2D,n.TEXTURE_2D,1),it[n.TEXTURE_CUBE_MAP]=X(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),it[n.TEXTURE_2D_ARRAY]=X(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),it[n.TEXTURE_3D]=X(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),a.setClear(1),o.setClear(0),j(n.DEPTH_TEST),a.setFunc(qi),Xt(!1),jt(Dc),j(n.CULL_FACE),mt(kn);function j(z){h[z]!==!0&&(n.enable(z),h[z]=!0)}function bt(z){h[z]!==!1&&(n.disable(z),h[z]=!1)}function Ct(z,ft){return u[z]!==ft?(n.bindFramebuffer(z,ft),u[z]=ft,z===n.DRAW_FRAMEBUFFER&&(u[n.FRAMEBUFFER]=ft),z===n.FRAMEBUFFER&&(u[n.DRAW_FRAMEBUFFER]=ft),!0):!1}function Rt(z,ft){let et=g,pt=!1;if(z){et=p.get(ft),et===void 0&&(et=[],p.set(ft,et));let vt=z.textures;if(et.length!==vt.length||et[0]!==n.COLOR_ATTACHMENT0){for(let rt=0,It=vt.length;rt<It;rt++)et[rt]=n.COLOR_ATTACHMENT0+rt;et.length=vt.length,pt=!0}}else et[0]!==n.BACK&&(et[0]=n.BACK,pt=!0);pt&&n.drawBuffers(et)}function Jt(z){return y!==z?(n.useProgram(z),y=z,!0):!1}let Bt={[gi]:n.FUNC_ADD,[tf]:n.FUNC_SUBTRACT,[ef]:n.FUNC_REVERSE_SUBTRACT};Bt[nf]=n.MIN,Bt[sf]=n.MAX;let $t={[rf]:n.ZERO,[af]:n.ONE,[of]:n.SRC_COLOR,[Fa]:n.SRC_ALPHA,[df]:n.SRC_ALPHA_SATURATE,[uf]:n.DST_COLOR,[cf]:n.DST_ALPHA,[lf]:n.ONE_MINUS_SRC_COLOR,[Oa]:n.ONE_MINUS_SRC_ALPHA,[ff]:n.ONE_MINUS_DST_COLOR,[hf]:n.ONE_MINUS_DST_ALPHA,[pf]:n.CONSTANT_COLOR,[mf]:n.ONE_MINUS_CONSTANT_COLOR,[gf]:n.CONSTANT_ALPHA,[_f]:n.ONE_MINUS_CONSTANT_ALPHA};function mt(z,ft,et,pt,vt,rt,It,Tt,me,ce){if(z===kn){m===!0&&(bt(n.BLEND),m=!1);return}if(m===!1&&(j(n.BLEND),m=!0),z!==Qu){if(z!==f||ce!==R){if((v!==gi||M!==gi)&&(n.blendEquation(n.FUNC_ADD),v=gi,M=gi),ce)switch(z){case Xi:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Lc:n.blendFunc(n.ONE,n.ONE);break;case Nc:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Uc:n.blendFuncSeparate(n.DST_COLOR,n.ONE_MINUS_SRC_ALPHA,n.ZERO,n.ONE);break;default:Ot("WebGLState: Invalid blending: ",z);break}else switch(z){case Xi:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Lc:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE,n.ONE,n.ONE);break;case Nc:Ot("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Uc:Ot("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Ot("WebGLState: Invalid blending: ",z);break}E=null,_=null,S=null,w=null,x.set(0,0,0),T=0,f=z,R=ce}return}vt=vt||ft,rt=rt||et,It=It||pt,(ft!==v||vt!==M)&&(n.blendEquationSeparate(Bt[ft],Bt[vt]),v=ft,M=vt),(et!==E||pt!==_||rt!==S||It!==w)&&(n.blendFuncSeparate($t[et],$t[pt],$t[rt],$t[It]),E=et,_=pt,S=rt,w=It),(Tt.equals(x)===!1||me!==T)&&(n.blendColor(Tt.r,Tt.g,Tt.b,me),x.copy(Tt),T=me),f=z,R=!1}function Et(z,ft){z.side===zn?bt(n.CULL_FACE):j(n.CULL_FACE);let et=z.side===We;ft&&(et=!et),Xt(et),z.blending===Xi&&z.transparent===!1?mt(kn):mt(z.blending,z.blendEquation,z.blendSrc,z.blendDst,z.blendEquationAlpha,z.blendSrcAlpha,z.blendDstAlpha,z.blendColor,z.blendAlpha,z.premultipliedAlpha),a.setFunc(z.depthFunc),a.setTest(z.depthTest),a.setMask(z.depthWrite),r.setMask(z.colorWrite);let pt=z.stencilWrite;o.setTest(pt),pt&&(o.setMask(z.stencilWriteMask),o.setFunc(z.stencilFunc,z.stencilRef,z.stencilFuncMask),o.setOp(z.stencilFail,z.stencilZFail,z.stencilZPass)),Ae(z.polygonOffset,z.polygonOffsetFactor,z.polygonOffsetUnits),z.alphaToCoverage===!0?j(n.SAMPLE_ALPHA_TO_COVERAGE):bt(n.SAMPLE_ALPHA_TO_COVERAGE)}function Xt(z){D!==z&&(z?n.frontFace(n.CW):n.frontFace(n.CCW),D=z)}function jt(z){z!==Ju?(j(n.CULL_FACE),z!==I&&(z===Dc?n.cullFace(n.BACK):z===Ku?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):bt(n.CULL_FACE),I=z}function ie(z){z!==O&&(L&&n.lineWidth(z),O=z)}function Ae(z,ft,et){z?(j(n.POLYGON_OFFSET_FILL),(C!==ft||N!==et)&&(C=ft,N=et,a.getReversed()&&(ft=-ft),n.polygonOffset(ft,et))):bt(n.POLYGON_OFFSET_FILL)}function at(z){z?j(n.SCISSOR_TEST):bt(n.SCISSOR_TEST)}function lt(z){z===void 0&&(z=n.TEXTURE0+U-1),Y!==z&&(n.activeTexture(z),Y=z)}function F(z,ft,et){et===void 0&&(Y===null?et=n.TEXTURE0+U-1:et=Y);let pt=tt[et];pt===void 0&&(pt={type:void 0,texture:void 0},tt[et]=pt),(pt.type!==z||pt.texture!==ft)&&(Y!==et&&(n.activeTexture(et),Y=et),n.bindTexture(z,ft||it[z]),pt.type=z,pt.texture=ft)}function se(){let z=tt[Y];z!==void 0&&z.type!==void 0&&(n.bindTexture(z.type,null),z.type=void 0,z.texture=void 0)}function Vt(){try{n.compressedTexImage2D(...arguments)}catch(z){Ot("WebGLState:",z)}}function P(){try{n.compressedTexImage3D(...arguments)}catch(z){Ot("WebGLState:",z)}}function b(){try{n.texSubImage2D(...arguments)}catch(z){Ot("WebGLState:",z)}}function G(){try{n.texSubImage3D(...arguments)}catch(z){Ot("WebGLState:",z)}}function W(){try{n.compressedTexSubImage2D(...arguments)}catch(z){Ot("WebGLState:",z)}}function J(){try{n.compressedTexSubImage3D(...arguments)}catch(z){Ot("WebGLState:",z)}}function ot(){try{n.texStorage2D(...arguments)}catch(z){Ot("WebGLState:",z)}}function ct(){try{n.texStorage3D(...arguments)}catch(z){Ot("WebGLState:",z)}}function K(){try{n.texImage2D(...arguments)}catch(z){Ot("WebGLState:",z)}}function Q(){try{n.texImage3D(...arguments)}catch(z){Ot("WebGLState:",z)}}function ut(z){return d[z]!==void 0?d[z]:n.getParameter(z)}function wt(z,ft){d[z]!==ft&&(n.pixelStorei(z,ft),d[z]=ft)}function gt(z){nt.equals(z)===!1&&(n.scissor(z.x,z.y,z.z,z.w),nt.copy(z))}function dt(z){ht.equals(z)===!1&&(n.viewport(z.x,z.y,z.z,z.w),ht.copy(z))}function Ut(z,ft){let et=l.get(ft);et===void 0&&(et=new WeakMap,l.set(ft,et));let pt=et.get(z);pt===void 0&&(pt=n.getUniformBlockIndex(ft,z.name),et.set(z,pt))}function zt(z,ft){let pt=l.get(ft).get(z);c.get(ft)!==pt&&(n.uniformBlockBinding(ft,pt,z.__bindingPointIndex),c.set(ft,pt))}function Gt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),a.setReversed(!1),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),n.pixelStorei(n.PACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_ALIGNMENT,4),n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,!1),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,n.BROWSER_DEFAULT_WEBGL),n.pixelStorei(n.PACK_ROW_LENGTH,0),n.pixelStorei(n.PACK_SKIP_PIXELS,0),n.pixelStorei(n.PACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_ROW_LENGTH,0),n.pixelStorei(n.UNPACK_IMAGE_HEIGHT,0),n.pixelStorei(n.UNPACK_SKIP_PIXELS,0),n.pixelStorei(n.UNPACK_SKIP_ROWS,0),n.pixelStorei(n.UNPACK_SKIP_IMAGES,0),h={},d={},Y=null,tt={},u={},p=new WeakMap,g=[],y=null,m=!1,f=null,v=null,E=null,_=null,M=null,S=null,w=null,x=new Zt(0,0,0),T=0,R=!1,D=null,I=null,O=null,C=null,N=null,nt.set(0,0,n.canvas.width,n.canvas.height),ht.set(0,0,n.canvas.width,n.canvas.height),r.reset(),a.reset(),o.reset()}return{buffers:{color:r,depth:a,stencil:o},enable:j,disable:bt,bindFramebuffer:Ct,drawBuffers:Rt,useProgram:Jt,setBlending:mt,setMaterial:Et,setFlipSided:Xt,setCullFace:jt,setLineWidth:ie,setPolygonOffset:Ae,setScissorTest:at,activeTexture:lt,bindTexture:F,unbindTexture:se,compressedTexImage2D:Vt,compressedTexImage3D:P,texImage2D:K,texImage3D:Q,pixelStorei:wt,getParameter:ut,updateUBOMapping:Ut,uniformBlockBinding:zt,texStorage2D:ot,texStorage3D:ct,texSubImage2D:b,texSubImage3D:G,compressedTexSubImage2D:W,compressedTexSubImage3D:J,scissor:gt,viewport:dt,reset:Gt}}function Qv(n,t,e,i,s,r,a){let o=t.has("WEBGL_multisampled_render_to_texture")?t.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator=="undefined"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Dt,h=new WeakMap,d=new Set,u,p=new WeakMap,g=!1;try{g=typeof OffscreenCanvas!="undefined"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch(P){}function y(P,b){return g?new OffscreenCanvas(P,b):ir("canvas")}function m(P,b,G){let W=1,J=Vt(P);if((J.width>G||J.height>G)&&(W=G/Math.max(J.width,J.height)),W<1)if(typeof HTMLImageElement!="undefined"&&P instanceof HTMLImageElement||typeof HTMLCanvasElement!="undefined"&&P instanceof HTMLCanvasElement||typeof ImageBitmap!="undefined"&&P instanceof ImageBitmap||typeof VideoFrame!="undefined"&&P instanceof VideoFrame){let ot=Math.floor(W*J.width),ct=Math.floor(W*J.height);u===void 0&&(u=y(ot,ct));let K=b?y(ot,ct):u;return K.width=ot,K.height=ct,K.getContext("2d").drawImage(P,0,0,ot,ct),Ft("WebGLRenderer: Texture has been resized from ("+J.width+"x"+J.height+") to ("+ot+"x"+ct+")."),K}else return"data"in P&&Ft("WebGLRenderer: Image in DataTexture is too big ("+J.width+"x"+J.height+")."),P;return P}function f(P){return P.generateMipmaps}function v(P){n.generateMipmap(P)}function E(P){return P.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:P.isWebGL3DRenderTarget?n.TEXTURE_3D:P.isWebGLArrayRenderTarget||P.isCompressedArrayTexture?n.TEXTURE_2D_ARRAY:n.TEXTURE_2D}function _(P,b,G,W,J,ot=!1){if(P!==null){if(n[P]!==void 0)return n[P];Ft("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+P+"'")}let ct;W&&(ct=t.get("EXT_texture_norm16"),ct||Ft("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let K=b;if(b===n.RED&&(G===n.FLOAT&&(K=n.R32F),G===n.HALF_FLOAT&&(K=n.R16F),G===n.UNSIGNED_BYTE&&(K=n.R8),G===n.UNSIGNED_SHORT&&ct&&(K=ct.R16_EXT),G===n.SHORT&&ct&&(K=ct.R16_SNORM_EXT)),b===n.RED_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.R8UI),G===n.UNSIGNED_SHORT&&(K=n.R16UI),G===n.UNSIGNED_INT&&(K=n.R32UI),G===n.BYTE&&(K=n.R8I),G===n.SHORT&&(K=n.R16I),G===n.INT&&(K=n.R32I)),b===n.RG&&(G===n.FLOAT&&(K=n.RG32F),G===n.HALF_FLOAT&&(K=n.RG16F),G===n.UNSIGNED_BYTE&&(K=n.RG8),G===n.UNSIGNED_SHORT&&ct&&(K=ct.RG16_EXT),G===n.SHORT&&ct&&(K=ct.RG16_SNORM_EXT)),b===n.RG_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RG8UI),G===n.UNSIGNED_SHORT&&(K=n.RG16UI),G===n.UNSIGNED_INT&&(K=n.RG32UI),G===n.BYTE&&(K=n.RG8I),G===n.SHORT&&(K=n.RG16I),G===n.INT&&(K=n.RG32I)),b===n.RGB_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RGB8UI),G===n.UNSIGNED_SHORT&&(K=n.RGB16UI),G===n.UNSIGNED_INT&&(K=n.RGB32UI),G===n.BYTE&&(K=n.RGB8I),G===n.SHORT&&(K=n.RGB16I),G===n.INT&&(K=n.RGB32I)),b===n.RGBA_INTEGER&&(G===n.UNSIGNED_BYTE&&(K=n.RGBA8UI),G===n.UNSIGNED_SHORT&&(K=n.RGBA16UI),G===n.UNSIGNED_INT&&(K=n.RGBA32UI),G===n.BYTE&&(K=n.RGBA8I),G===n.SHORT&&(K=n.RGBA16I),G===n.INT&&(K=n.RGBA32I)),b===n.RGB&&(G===n.UNSIGNED_SHORT&&ct&&(K=ct.RGB16_EXT),G===n.SHORT&&ct&&(K=ct.RGB16_SNORM_EXT),G===n.UNSIGNED_INT_5_9_9_9_REV&&(K=n.RGB9_E5),G===n.UNSIGNED_INT_10F_11F_11F_REV&&(K=n.R11F_G11F_B10F)),b===n.RGBA){let Q=ot?er:Kt.getTransfer(J);G===n.FLOAT&&(K=n.RGBA32F),G===n.HALF_FLOAT&&(K=n.RGBA16F),G===n.UNSIGNED_BYTE&&(K=Q===te?n.SRGB8_ALPHA8:n.RGBA8),G===n.UNSIGNED_SHORT&&ct&&(K=ct.RGBA16_EXT),G===n.SHORT&&ct&&(K=ct.RGBA16_SNORM_EXT),G===n.UNSIGNED_SHORT_4_4_4_4&&(K=n.RGBA4),G===n.UNSIGNED_SHORT_5_5_5_1&&(K=n.RGB5_A1)}return(K===n.R16F||K===n.R32F||K===n.RG16F||K===n.RG32F||K===n.RGBA16F||K===n.RGBA32F)&&t.get("EXT_color_buffer_float"),K}function M(P,b){let G;return P?b===null||b===wn||b===Ls?G=n.DEPTH24_STENCIL8:b===En?G=n.DEPTH32F_STENCIL8:b===Ds&&(G=n.DEPTH24_STENCIL8,Ft("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):b===null||b===wn||b===Ls?G=n.DEPTH_COMPONENT24:b===En?G=n.DEPTH_COMPONENT32F:b===Ds&&(G=n.DEPTH_COMPONENT16),G}function S(P,b){return f(P)===!0||P.isFramebufferTexture&&P.minFilter!==Re&&P.minFilter!==De?Math.log2(Math.max(b.width,b.height))+1:P.mipmaps!==void 0&&P.mipmaps.length>0?P.mipmaps.length:P.isCompressedTexture&&Array.isArray(P.image)?b.mipmaps.length:1}function w(P){let b=P.target;b.removeEventListener("dispose",w),T(b),b.isVideoTexture&&h.delete(b),b.isHTMLTexture&&d.delete(b)}function x(P){let b=P.target;b.removeEventListener("dispose",x),D(b)}function T(P){let b=i.get(P);if(b.__webglInit===void 0)return;let G=P.source,W=p.get(G);if(W){let J=W[b.__cacheKey];J.usedTimes--,J.usedTimes===0&&R(P),Object.keys(W).length===0&&p.delete(G)}i.remove(P)}function R(P){let b=i.get(P);n.deleteTexture(b.__webglTexture);let G=P.source,W=p.get(G);delete W[b.__cacheKey],a.memory.textures--}function D(P){let b=i.get(P);if(P.depthTexture&&(P.depthTexture.dispose(),i.remove(P.depthTexture)),P.isWebGLCubeRenderTarget)for(let W=0;W<6;W++){if(Array.isArray(b.__webglFramebuffer[W]))for(let J=0;J<b.__webglFramebuffer[W].length;J++)n.deleteFramebuffer(b.__webglFramebuffer[W][J]);else n.deleteFramebuffer(b.__webglFramebuffer[W]);b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer[W])}else{if(Array.isArray(b.__webglFramebuffer))for(let W=0;W<b.__webglFramebuffer.length;W++)n.deleteFramebuffer(b.__webglFramebuffer[W]);else n.deleteFramebuffer(b.__webglFramebuffer);if(b.__webglDepthbuffer&&n.deleteRenderbuffer(b.__webglDepthbuffer),b.__webglMultisampledFramebuffer&&n.deleteFramebuffer(b.__webglMultisampledFramebuffer),b.__webglColorRenderbuffer)for(let W=0;W<b.__webglColorRenderbuffer.length;W++)b.__webglColorRenderbuffer[W]&&n.deleteRenderbuffer(b.__webglColorRenderbuffer[W]);b.__webglDepthRenderbuffer&&n.deleteRenderbuffer(b.__webglDepthRenderbuffer)}let G=P.textures;for(let W=0,J=G.length;W<J;W++){let ot=i.get(G[W]);ot.__webglTexture&&(n.deleteTexture(ot.__webglTexture),a.memory.textures--),i.remove(G[W])}i.remove(P)}let I=0;function O(){I=0}function C(){return I}function N(P){I=P}function U(){let P=I;return P>=s.maxTextures&&Ft("WebGLTextures: Trying to use "+P+" texture units while this GPU supports only "+s.maxTextures),I+=1,P}function L(P){let b=[];return b.push(P.wrapS),b.push(P.wrapT),b.push(P.wrapR||0),b.push(P.magFilter),b.push(P.minFilter),b.push(P.anisotropy),b.push(P.internalFormat),b.push(P.format),b.push(P.type),b.push(P.generateMipmaps),b.push(P.premultiplyAlpha),b.push(P.flipY),b.push(P.unpackAlignment),b.push(P.colorSpace),b.join()}function B(P,b){let G=i.get(P);if(P.isVideoTexture&&F(P),P.isRenderTargetTexture===!1&&P.isExternalTexture!==!0&&P.version>0&&G.__version!==P.version){let W=P.image;if(W===null)Ft("WebGLRenderer: Texture marked for update but no image data found.");else if(W.complete===!1)Ft("WebGLRenderer: Texture marked for update but image is incomplete");else{bt(G,P,b);return}}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);e.bindTexture(n.TEXTURE_2D,G.__webglTexture,n.TEXTURE0+b)}function H(P,b){let G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){bt(G,P,b);return}else P.isExternalTexture&&(G.__webglTexture=P.sourceTexture?P.sourceTexture:null);e.bindTexture(n.TEXTURE_2D_ARRAY,G.__webglTexture,n.TEXTURE0+b)}function Y(P,b){let G=i.get(P);if(P.isRenderTargetTexture===!1&&P.version>0&&G.__version!==P.version){bt(G,P,b);return}e.bindTexture(n.TEXTURE_3D,G.__webglTexture,n.TEXTURE0+b)}function tt(P,b){let G=i.get(P);if(P.isCubeDepthTexture!==!0&&P.version>0&&G.__version!==P.version){Ct(G,P,b);return}e.bindTexture(n.TEXTURE_CUBE_MAP,G.__webglTexture,n.TEXTURE0+b)}let st={[Xa]:n.REPEAT,[Fn]:n.CLAMP_TO_EDGE,[qa]:n.MIRRORED_REPEAT},Nt={[Re]:n.NEAREST,[vf]:n.NEAREST_MIPMAP_NEAREST,[Ar]:n.NEAREST_MIPMAP_LINEAR,[De]:n.LINEAR,[Eo]:n.LINEAR_MIPMAP_NEAREST,[Ci]:n.LINEAR_MIPMAP_LINEAR},nt={[Sf]:n.NEVER,[Cf]:n.ALWAYS,[wf]:n.LESS,[ll]:n.LEQUAL,[Ef]:n.EQUAL,[cl]:n.GEQUAL,[Tf]:n.GREATER,[Af]:n.NOTEQUAL};function ht(P,b){if(b.type===En&&t.has("OES_texture_float_linear")===!1&&(b.magFilter===De||b.magFilter===Eo||b.magFilter===Ar||b.magFilter===Ci||b.minFilter===De||b.minFilter===Eo||b.minFilter===Ar||b.minFilter===Ci)&&Ft("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(P,n.TEXTURE_WRAP_S,st[b.wrapS]),n.texParameteri(P,n.TEXTURE_WRAP_T,st[b.wrapT]),(P===n.TEXTURE_3D||P===n.TEXTURE_2D_ARRAY)&&n.texParameteri(P,n.TEXTURE_WRAP_R,st[b.wrapR]),n.texParameteri(P,n.TEXTURE_MAG_FILTER,Nt[b.magFilter]),n.texParameteri(P,n.TEXTURE_MIN_FILTER,Nt[b.minFilter]),b.compareFunction&&(n.texParameteri(P,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(P,n.TEXTURE_COMPARE_FUNC,nt[b.compareFunction])),t.has("EXT_texture_filter_anisotropic")===!0){if(b.magFilter===Re||b.minFilter!==Ar&&b.minFilter!==Ci||b.type===En&&t.has("OES_texture_float_linear")===!1)return;if(b.anisotropy>1||i.get(b).__currentAnisotropy){let G=t.get("EXT_texture_filter_anisotropic");n.texParameterf(P,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(b.anisotropy,s.getMaxAnisotropy())),i.get(b).__currentAnisotropy=b.anisotropy}}}function X(P,b){let G=!1;P.__webglInit===void 0&&(P.__webglInit=!0,b.addEventListener("dispose",w));let W=b.source,J=p.get(W);J===void 0&&(J={},p.set(W,J));let ot=L(b);if(ot!==P.__cacheKey){J[ot]===void 0&&(J[ot]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,G=!0),J[ot].usedTimes++;let ct=J[P.__cacheKey];ct!==void 0&&(J[P.__cacheKey].usedTimes--,ct.usedTimes===0&&R(b)),P.__cacheKey=ot,P.__webglTexture=J[ot].texture}return G}function it(P,b,G){return Math.floor(Math.floor(P/G)/b)}function j(P,b,G,W){let ot=P.updateRanges;if(ot.length===0)e.texSubImage2D(n.TEXTURE_2D,0,0,0,b.width,b.height,G,W,b.data);else{ot.sort((wt,gt)=>wt.start-gt.start);let ct=0;for(let wt=1;wt<ot.length;wt++){let gt=ot[ct],dt=ot[wt],Ut=gt.start+gt.count,zt=it(dt.start,b.width,4),Gt=it(gt.start,b.width,4);dt.start<=Ut+1&&zt===Gt&&it(dt.start+dt.count-1,b.width,4)===zt?gt.count=Math.max(gt.count,dt.start+dt.count-gt.start):(++ct,ot[ct]=dt)}ot.length=ct+1;let K=e.getParameter(n.UNPACK_ROW_LENGTH),Q=e.getParameter(n.UNPACK_SKIP_PIXELS),ut=e.getParameter(n.UNPACK_SKIP_ROWS);e.pixelStorei(n.UNPACK_ROW_LENGTH,b.width);for(let wt=0,gt=ot.length;wt<gt;wt++){let dt=ot[wt],Ut=Math.floor(dt.start/4),zt=Math.ceil(dt.count/4),Gt=Ut%b.width,z=Math.floor(Ut/b.width),ft=zt,et=1;e.pixelStorei(n.UNPACK_SKIP_PIXELS,Gt),e.pixelStorei(n.UNPACK_SKIP_ROWS,z),e.texSubImage2D(n.TEXTURE_2D,0,Gt,z,ft,et,G,W,b.data)}P.clearUpdateRanges(),e.pixelStorei(n.UNPACK_ROW_LENGTH,K),e.pixelStorei(n.UNPACK_SKIP_PIXELS,Q),e.pixelStorei(n.UNPACK_SKIP_ROWS,ut)}}function bt(P,b,G){let W=n.TEXTURE_2D;(b.isDataArrayTexture||b.isCompressedArrayTexture)&&(W=n.TEXTURE_2D_ARRAY),b.isData3DTexture&&(W=n.TEXTURE_3D);let J=X(P,b),ot=b.source;e.bindTexture(W,P.__webglTexture,n.TEXTURE0+G);let ct=i.get(ot);if(ot.version!==ct.__version||J===!0){if(e.activeTexture(n.TEXTURE0+G),(typeof ImageBitmap!="undefined"&&b.image instanceof ImageBitmap)===!1){let et=Kt.getPrimaries(Kt.workingColorSpace),pt=b.colorSpace===ni?null:Kt.getPrimaries(b.colorSpace),vt=b.colorSpace===ni||et===pt?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,vt)}e.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment);let Q=m(b.image,!1,s.maxTextureSize);Q=se(b,Q);let ut=r.convert(b.format,b.colorSpace),wt=r.convert(b.type),gt=_(b.internalFormat,ut,wt,b.normalized,b.colorSpace,b.isVideoTexture);ht(W,b);let dt,Ut=b.mipmaps,zt=b.isVideoTexture!==!0,Gt=ct.__version===void 0||J===!0,z=ot.dataReady,ft=S(b,Q);if(b.isDepthTexture)gt=M(b.format===Ri,b.type),Gt&&(zt?e.texStorage2D(n.TEXTURE_2D,1,gt,Q.width,Q.height):e.texImage2D(n.TEXTURE_2D,0,gt,Q.width,Q.height,0,ut,wt,null));else if(b.isDataTexture)if(Ut.length>0){zt&&Gt&&e.texStorage2D(n.TEXTURE_2D,ft,gt,Ut[0].width,Ut[0].height);for(let et=0,pt=Ut.length;et<pt;et++)dt=Ut[et],zt?z&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,ut,wt,dt.data):e.texImage2D(n.TEXTURE_2D,et,gt,dt.width,dt.height,0,ut,wt,dt.data);b.generateMipmaps=!1}else zt?(Gt&&e.texStorage2D(n.TEXTURE_2D,ft,gt,Q.width,Q.height),z&&j(b,Q,ut,wt)):e.texImage2D(n.TEXTURE_2D,0,gt,Q.width,Q.height,0,ut,wt,Q.data);else if(b.isCompressedTexture)if(b.isCompressedArrayTexture){zt&&Gt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ft,gt,Ut[0].width,Ut[0].height,Q.depth);for(let et=0,pt=Ut.length;et<pt;et++)if(dt=Ut[et],b.format!==un)if(ut!==null)if(zt){if(z)if(b.layerUpdates.size>0){let vt=rh(dt.width,dt.height,b.format,b.type);for(let rt of b.layerUpdates){let It=dt.data.subarray(rt*vt/dt.data.BYTES_PER_ELEMENT,(rt+1)*vt/dt.data.BYTES_PER_ELEMENT);e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,rt,dt.width,dt.height,1,ut,It)}b.clearLayerUpdates()}else e.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,0,dt.width,dt.height,Q.depth,ut,dt.data)}else e.compressedTexImage3D(n.TEXTURE_2D_ARRAY,et,gt,dt.width,dt.height,Q.depth,0,dt.data,0,0);else Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else zt?z&&e.texSubImage3D(n.TEXTURE_2D_ARRAY,et,0,0,0,dt.width,dt.height,Q.depth,ut,wt,dt.data):e.texImage3D(n.TEXTURE_2D_ARRAY,et,gt,dt.width,dt.height,Q.depth,0,ut,wt,dt.data)}else{zt&&Gt&&e.texStorage2D(n.TEXTURE_2D,ft,gt,Ut[0].width,Ut[0].height);for(let et=0,pt=Ut.length;et<pt;et++)dt=Ut[et],b.format!==un?ut!==null?zt?z&&e.compressedTexSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,ut,dt.data):e.compressedTexImage2D(n.TEXTURE_2D,et,gt,dt.width,dt.height,0,dt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):zt?z&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,dt.width,dt.height,ut,wt,dt.data):e.texImage2D(n.TEXTURE_2D,et,gt,dt.width,dt.height,0,ut,wt,dt.data)}else if(b.isDataArrayTexture)if(zt){if(Gt&&e.texStorage3D(n.TEXTURE_2D_ARRAY,ft,gt,Q.width,Q.height,Q.depth),z)if(b.layerUpdates.size>0){let et=rh(Q.width,Q.height,b.format,b.type);for(let pt of b.layerUpdates){let vt=Q.data.subarray(pt*et/Q.data.BYTES_PER_ELEMENT,(pt+1)*et/Q.data.BYTES_PER_ELEMENT);e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,pt,Q.width,Q.height,1,ut,wt,vt)}b.clearLayerUpdates()}else e.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,Q.width,Q.height,Q.depth,ut,wt,Q.data)}else e.texImage3D(n.TEXTURE_2D_ARRAY,0,gt,Q.width,Q.height,Q.depth,0,ut,wt,Q.data);else if(b.isData3DTexture)zt?(Gt&&e.texStorage3D(n.TEXTURE_3D,ft,gt,Q.width,Q.height,Q.depth),z&&e.texSubImage3D(n.TEXTURE_3D,0,0,0,0,Q.width,Q.height,Q.depth,ut,wt,Q.data)):e.texImage3D(n.TEXTURE_3D,0,gt,Q.width,Q.height,Q.depth,0,ut,wt,Q.data);else if(b.isFramebufferTexture){if(Gt)if(zt)e.texStorage2D(n.TEXTURE_2D,ft,gt,Q.width,Q.height);else{let et=Q.width,pt=Q.height;for(let vt=0;vt<ft;vt++)e.texImage2D(n.TEXTURE_2D,vt,gt,et,pt,0,ut,wt,null),et>>=1,pt>>=1}}else if(b.isHTMLTexture){if("texElementImage2D"in n){let et=n.canvas;if(et.hasAttribute("layoutsubtree")||et.setAttribute("layoutsubtree","true"),Q.parentNode!==et){et.appendChild(Q),d.add(b),et.onpaint=pt=>{let vt=pt.changedElements;for(let rt of d)vt.includes(rt.image)&&(rt.needsUpdate=!0)},et.requestPaint();return}if(n.texElementImage2D.length===3)n.texElementImage2D(n.TEXTURE_2D,n.RGBA8,Q);else{let vt=n.RGBA,rt=n.RGBA,It=n.UNSIGNED_BYTE;n.texElementImage2D(n.TEXTURE_2D,0,vt,rt,It,Q)}n.texParameteri(n.TEXTURE_2D,n.TEXTURE_MIN_FILTER,n.LINEAR),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_S,n.CLAMP_TO_EDGE),n.texParameteri(n.TEXTURE_2D,n.TEXTURE_WRAP_T,n.CLAMP_TO_EDGE)}}else if(Ut.length>0){if(zt&&Gt){let et=Vt(Ut[0]);e.texStorage2D(n.TEXTURE_2D,ft,gt,et.width,et.height)}for(let et=0,pt=Ut.length;et<pt;et++)dt=Ut[et],zt?z&&e.texSubImage2D(n.TEXTURE_2D,et,0,0,ut,wt,dt):e.texImage2D(n.TEXTURE_2D,et,gt,ut,wt,dt);b.generateMipmaps=!1}else if(zt){if(Gt){let et=Vt(Q);e.texStorage2D(n.TEXTURE_2D,ft,gt,et.width,et.height)}z&&e.texSubImage2D(n.TEXTURE_2D,0,0,0,ut,wt,Q)}else e.texImage2D(n.TEXTURE_2D,0,gt,ut,wt,Q);f(b)&&v(W),ct.__version=ot.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function Ct(P,b,G){if(b.image.length!==6)return;let W=X(P,b),J=b.source;e.bindTexture(n.TEXTURE_CUBE_MAP,P.__webglTexture,n.TEXTURE0+G);let ot=i.get(J);if(J.version!==ot.__version||W===!0){e.activeTexture(n.TEXTURE0+G);let ct=Kt.getPrimaries(Kt.workingColorSpace),K=b.colorSpace===ni?null:Kt.getPrimaries(b.colorSpace),Q=b.colorSpace===ni||ct===K?n.NONE:n.BROWSER_DEFAULT_WEBGL;e.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,b.flipY),e.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,b.premultiplyAlpha),e.pixelStorei(n.UNPACK_ALIGNMENT,b.unpackAlignment),e.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Q);let ut=b.isCompressedTexture||b.image[0].isCompressedTexture,wt=b.image[0]&&b.image[0].isDataTexture,gt=[];for(let rt=0;rt<6;rt++)!ut&&!wt?gt[rt]=m(b.image[rt],!0,s.maxCubemapSize):gt[rt]=wt?b.image[rt].image:b.image[rt],gt[rt]=se(b,gt[rt]);let dt=gt[0],Ut=r.convert(b.format,b.colorSpace),zt=r.convert(b.type),Gt=_(b.internalFormat,Ut,zt,b.normalized,b.colorSpace),z=b.isVideoTexture!==!0,ft=ot.__version===void 0||W===!0,et=J.dataReady,pt=S(b,dt);ht(n.TEXTURE_CUBE_MAP,b);let vt;if(ut){z&&ft&&e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Gt,dt.width,dt.height);for(let rt=0;rt<6;rt++){vt=gt[rt].mipmaps;for(let It=0;It<vt.length;It++){let Tt=vt[It];b.format!==un?Ut!==null?z?et&&e.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It,0,0,Tt.width,Tt.height,Ut,Tt.data):e.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It,Gt,Tt.width,Tt.height,0,Tt.data):Ft("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):z?et&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It,0,0,Tt.width,Tt.height,Ut,zt,Tt.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It,Gt,Tt.width,Tt.height,0,Ut,zt,Tt.data)}}}else{if(vt=b.mipmaps,z&&ft){vt.length>0&&pt++;let rt=Vt(gt[0]);e.texStorage2D(n.TEXTURE_CUBE_MAP,pt,Gt,rt.width,rt.height)}for(let rt=0;rt<6;rt++)if(wt){z?et&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,0,0,gt[rt].width,gt[rt].height,Ut,zt,gt[rt].data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,Gt,gt[rt].width,gt[rt].height,0,Ut,zt,gt[rt].data);for(let It=0;It<vt.length;It++){let me=vt[It].image[rt].image;z?et&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It+1,0,0,me.width,me.height,Ut,zt,me.data):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It+1,Gt,me.width,me.height,0,Ut,zt,me.data)}}else{z?et&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,0,0,Ut,zt,gt[rt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,0,Gt,Ut,zt,gt[rt]);for(let It=0;It<vt.length;It++){let Tt=vt[It];z?et&&e.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It+1,0,0,Ut,zt,Tt.image[rt]):e.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+rt,It+1,Gt,Ut,zt,Tt.image[rt])}}}f(b)&&v(n.TEXTURE_CUBE_MAP),ot.__version=J.version,b.onUpdate&&b.onUpdate(b)}P.__version=b.version}function Rt(P,b,G,W,J,ot){let ct=r.convert(G.format,G.colorSpace),K=r.convert(G.type),Q=_(G.internalFormat,ct,K,G.normalized,G.colorSpace),ut=i.get(b),wt=i.get(G);if(wt.__renderTarget=b,!ut.__hasExternalTextures){let gt=Math.max(1,b.width>>ot),dt=Math.max(1,b.height>>ot);J===n.TEXTURE_3D||J===n.TEXTURE_2D_ARRAY?e.texImage3D(J,ot,Q,gt,dt,b.depth,0,ct,K,null):e.texImage2D(J,ot,Q,gt,dt,0,ct,K,null)}e.bindFramebuffer(n.FRAMEBUFFER,P),lt(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,W,J,wt.__webglTexture,0,at(b)):(J===n.TEXTURE_2D||J>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&J<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,W,J,wt.__webglTexture,ot),e.bindFramebuffer(n.FRAMEBUFFER,null)}function Jt(P,b,G){if(n.bindRenderbuffer(n.RENDERBUFFER,P),b.depthBuffer){let W=b.depthTexture,J=W&&W.isDepthTexture?W.type:null,ot=M(b.stencilBuffer,J),ct=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;lt(b)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,at(b),ot,b.width,b.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,at(b),ot,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,ot,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,ct,n.RENDERBUFFER,P)}else{let W=b.textures;for(let J=0;J<W.length;J++){let ot=W[J],ct=r.convert(ot.format,ot.colorSpace),K=r.convert(ot.type),Q=_(ot.internalFormat,ct,K,ot.normalized,ot.colorSpace);lt(b)?o.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,at(b),Q,b.width,b.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,at(b),Q,b.width,b.height):n.renderbufferStorage(n.RENDERBUFFER,Q,b.width,b.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function Bt(P,b,G){let W=b.isWebGLCubeRenderTarget===!0;if(e.bindFramebuffer(n.FRAMEBUFFER,P),!(b.depthTexture&&b.depthTexture.isDepthTexture))throw new Error("THREE.WebGLTextures: renderTarget.depthTexture must be an instance of THREE.DepthTexture.");let J=i.get(b.depthTexture);if(J.__renderTarget=b,(!J.__webglTexture||b.depthTexture.image.width!==b.width||b.depthTexture.image.height!==b.height)&&(b.depthTexture.image.width=b.width,b.depthTexture.image.height=b.height,b.depthTexture.needsUpdate=!0),W){if(J.__webglInit===void 0&&(J.__webglInit=!0,b.depthTexture.addEventListener("dispose",w)),J.__webglTexture===void 0){J.__webglTexture=n.createTexture(),e.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),ht(n.TEXTURE_CUBE_MAP,b.depthTexture);let ut=r.convert(b.depthTexture.format),wt=r.convert(b.depthTexture.type),gt;b.depthTexture.format===On?gt=n.DEPTH_COMPONENT24:b.depthTexture.format===Ri&&(gt=n.DEPTH24_STENCIL8);for(let dt=0;dt<6;dt++)n.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+dt,0,gt,b.width,b.height,0,ut,wt,null)}}else B(b.depthTexture,0);let ot=J.__webglTexture,ct=at(b),K=W?n.TEXTURE_CUBE_MAP_POSITIVE_X+G:n.TEXTURE_2D,Q=b.depthTexture.format===Ri?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;if(b.depthTexture.format===On)lt(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,K,ot,0,ct):n.framebufferTexture2D(n.FRAMEBUFFER,Q,K,ot,0);else if(b.depthTexture.format===Ri)lt(b)?o.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,Q,K,ot,0,ct):n.framebufferTexture2D(n.FRAMEBUFFER,Q,K,ot,0);else throw new Error("THREE.WebGLTextures: Unknown depthTexture format.")}function $t(P){let b=i.get(P),G=P.isWebGLCubeRenderTarget===!0;if(b.__boundDepthTexture!==P.depthTexture){let W=P.depthTexture;if(b.__depthDisposeCallback&&b.__depthDisposeCallback(),W){let J=()=>{delete b.__boundDepthTexture,delete b.__depthDisposeCallback,W.removeEventListener("dispose",J)};W.addEventListener("dispose",J),b.__depthDisposeCallback=J}b.__boundDepthTexture=W}if(P.depthTexture&&!b.__autoAllocateDepthBuffer)if(G)for(let W=0;W<6;W++)Bt(b.__webglFramebuffer[W],P,W);else{let W=P.texture.mipmaps;W&&W.length>0?Bt(b.__webglFramebuffer[0],P,0):Bt(b.__webglFramebuffer,P,0)}else if(G){b.__webglDepthbuffer=[];for(let W=0;W<6;W++)if(e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[W]),b.__webglDepthbuffer[W]===void 0)b.__webglDepthbuffer[W]=n.createRenderbuffer(),Jt(b.__webglDepthbuffer[W],P,!1);else{let J=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ot=b.__webglDepthbuffer[W];n.bindRenderbuffer(n.RENDERBUFFER,ot),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,ot)}}else{let W=P.texture.mipmaps;if(W&&W.length>0?e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer[0]):e.bindFramebuffer(n.FRAMEBUFFER,b.__webglFramebuffer),b.__webglDepthbuffer===void 0)b.__webglDepthbuffer=n.createRenderbuffer(),Jt(b.__webglDepthbuffer,P,!1);else{let J=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ot=b.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ot),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,ot)}}e.bindFramebuffer(n.FRAMEBUFFER,null)}function mt(P,b,G){let W=i.get(P);b!==void 0&&Rt(W.__webglFramebuffer,P,P.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),G!==void 0&&$t(P)}function Et(P){let b=P.texture,G=i.get(P),W=i.get(b);P.addEventListener("dispose",x);let J=P.textures,ot=P.isWebGLCubeRenderTarget===!0,ct=J.length>1;if(ct||(W.__webglTexture===void 0&&(W.__webglTexture=n.createTexture()),W.__version=b.version,a.memory.textures++),ot){G.__webglFramebuffer=[];for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0){G.__webglFramebuffer[K]=[];for(let Q=0;Q<b.mipmaps.length;Q++)G.__webglFramebuffer[K][Q]=n.createFramebuffer()}else G.__webglFramebuffer[K]=n.createFramebuffer()}else{if(b.mipmaps&&b.mipmaps.length>0){G.__webglFramebuffer=[];for(let K=0;K<b.mipmaps.length;K++)G.__webglFramebuffer[K]=n.createFramebuffer()}else G.__webglFramebuffer=n.createFramebuffer();if(ct)for(let K=0,Q=J.length;K<Q;K++){let ut=i.get(J[K]);ut.__webglTexture===void 0&&(ut.__webglTexture=n.createTexture(),a.memory.textures++)}if(P.samples>0&&lt(P)===!1){G.__webglMultisampledFramebuffer=n.createFramebuffer(),G.__webglColorRenderbuffer=[],e.bindFramebuffer(n.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let K=0;K<J.length;K++){let Q=J[K];G.__webglColorRenderbuffer[K]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,G.__webglColorRenderbuffer[K]);let ut=r.convert(Q.format,Q.colorSpace),wt=r.convert(Q.type),gt=_(Q.internalFormat,ut,wt,Q.normalized,Q.colorSpace,P.isXRRenderTarget===!0),dt=at(P);n.renderbufferStorageMultisample(n.RENDERBUFFER,dt,gt,P.width,P.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+K,n.RENDERBUFFER,G.__webglColorRenderbuffer[K])}n.bindRenderbuffer(n.RENDERBUFFER,null),P.depthBuffer&&(G.__webglDepthRenderbuffer=n.createRenderbuffer(),Jt(G.__webglDepthRenderbuffer,P,!0)),e.bindFramebuffer(n.FRAMEBUFFER,null)}}if(ot){e.bindTexture(n.TEXTURE_CUBE_MAP,W.__webglTexture),ht(n.TEXTURE_CUBE_MAP,b);for(let K=0;K<6;K++)if(b.mipmaps&&b.mipmaps.length>0)for(let Q=0;Q<b.mipmaps.length;Q++)Rt(G.__webglFramebuffer[K][Q],P,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,Q);else Rt(G.__webglFramebuffer[K],P,b,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+K,0);f(b)&&v(n.TEXTURE_CUBE_MAP),e.unbindTexture()}else if(ct){for(let K=0,Q=J.length;K<Q;K++){let ut=J[K],wt=i.get(ut),gt=n.TEXTURE_2D;(P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(gt=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(gt,wt.__webglTexture),ht(gt,ut),Rt(G.__webglFramebuffer,P,ut,n.COLOR_ATTACHMENT0+K,gt,0),f(ut)&&v(gt)}e.unbindTexture()}else{let K=n.TEXTURE_2D;if((P.isWebGL3DRenderTarget||P.isWebGLArrayRenderTarget)&&(K=P.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),e.bindTexture(K,W.__webglTexture),ht(K,b),b.mipmaps&&b.mipmaps.length>0)for(let Q=0;Q<b.mipmaps.length;Q++)Rt(G.__webglFramebuffer[Q],P,b,n.COLOR_ATTACHMENT0,K,Q);else Rt(G.__webglFramebuffer,P,b,n.COLOR_ATTACHMENT0,K,0);f(b)&&v(K),e.unbindTexture()}P.depthBuffer&&$t(P)}function Xt(P){let b=P.textures;for(let G=0,W=b.length;G<W;G++){let J=b[G];if(f(J)){let ot=E(P),ct=i.get(J).__webglTexture;e.bindTexture(ot,ct),v(ot),e.unbindTexture()}}}let jt=[],ie=[];function Ae(P){if(P.samples>0){if(lt(P)===!1){let b=P.textures,G=P.width,W=P.height,J=n.COLOR_BUFFER_BIT,ot=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ct=i.get(P),K=b.length>1;if(K)for(let ut=0;ut<b.length;ut++)e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.RENDERBUFFER,null),e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.TEXTURE_2D,null,0);e.bindFramebuffer(n.READ_FRAMEBUFFER,ct.__webglMultisampledFramebuffer);let Q=P.texture.mipmaps;Q&&Q.length>0?e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglFramebuffer[0]):e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglFramebuffer);for(let ut=0;ut<b.length;ut++){if(P.resolveDepthBuffer&&(P.depthBuffer&&(J|=n.DEPTH_BUFFER_BIT),P.stencilBuffer&&P.resolveStencilBuffer&&(J|=n.STENCIL_BUFFER_BIT)),K){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,ct.__webglColorRenderbuffer[ut]);let wt=i.get(b[ut]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,wt,0)}n.blitFramebuffer(0,0,G,W,0,0,G,W,J,n.NEAREST),c===!0&&(jt.length=0,ie.length=0,jt.push(n.COLOR_ATTACHMENT0+ut),P.depthBuffer&&P.resolveDepthBuffer===!1&&(jt.push(ot),ie.push(ot),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,ie)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,jt))}if(e.bindFramebuffer(n.READ_FRAMEBUFFER,null),e.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),K)for(let ut=0;ut<b.length;ut++){e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.RENDERBUFFER,ct.__webglColorRenderbuffer[ut]);let wt=i.get(b[ut]).__webglTexture;e.bindFramebuffer(n.FRAMEBUFFER,ct.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+ut,n.TEXTURE_2D,wt,0)}e.bindFramebuffer(n.DRAW_FRAMEBUFFER,ct.__webglMultisampledFramebuffer)}else if(P.depthBuffer&&P.resolveDepthBuffer===!1&&c){let b=P.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[b])}}}function at(P){return Math.min(s.maxSamples,P.samples)}function lt(P){let b=i.get(P);return P.samples>0&&t.has("WEBGL_multisampled_render_to_texture")===!0&&b.__useRenderToTexture!==!1}function F(P){let b=a.render.frame;h.get(P)!==b&&(h.set(P,b),P.update())}function se(P,b){let G=P.colorSpace,W=P.format,J=P.type;return P.isCompressedTexture===!0||P.isVideoTexture===!0||G!==tr&&G!==ni&&(Kt.getTransfer(G)===te?(W!==un||J!==on)&&Ft("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Ot("WebGLTextures: Unsupported texture color space:",G)),b}function Vt(P){return typeof HTMLImageElement!="undefined"&&P instanceof HTMLImageElement?(l.width=P.naturalWidth||P.width,l.height=P.naturalHeight||P.height):typeof VideoFrame!="undefined"&&P instanceof VideoFrame?(l.width=P.displayWidth,l.height=P.displayHeight):(l.width=P.width,l.height=P.height),l}this.allocateTextureUnit=U,this.resetTextureUnits=O,this.getTextureUnits=C,this.setTextureUnits=N,this.setTexture2D=B,this.setTexture2DArray=H,this.setTexture3D=Y,this.setTextureCube=tt,this.rebindTextures=mt,this.setupRenderTarget=Et,this.updateRenderTargetMipmap=Xt,this.updateMultisampleRenderTarget=Ae,this.setupDepthRenderbuffer=$t,this.setupFrameBufferTexture=Rt,this.useMultisampledRTT=lt,this.isReversedDepthBuffer=function(){return e.buffers.depth.getReversed()}}function tb(n,t){function e(i,s=ni){let r,a=Kt.getTransfer(s);if(i===on)return n.UNSIGNED_BYTE;if(i===Ao)return n.UNSIGNED_SHORT_4_4_4_4;if(i===Co)return n.UNSIGNED_SHORT_5_5_5_1;if(i===Yc)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===Zc)return n.UNSIGNED_INT_10F_11F_11F_REV;if(i===Xc)return n.BYTE;if(i===qc)return n.SHORT;if(i===Ds)return n.UNSIGNED_SHORT;if(i===To)return n.INT;if(i===wn)return n.UNSIGNED_INT;if(i===En)return n.FLOAT;if(i===Vn)return n.HALF_FLOAT;if(i===$c)return n.ALPHA;if(i===Jc)return n.RGB;if(i===un)return n.RGBA;if(i===On)return n.DEPTH_COMPONENT;if(i===Ri)return n.DEPTH_STENCIL;if(i===Kc)return n.RED;if(i===Ro)return n.RED_INTEGER;if(i===Ii)return n.RG;if(i===Io)return n.RG_INTEGER;if(i===Po)return n.RGBA_INTEGER;if(i===Cr||i===Rr||i===Ir||i===Pr)if(a===te)if(r=t.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(i===Cr)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===Rr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===Ir)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===Pr)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=t.get("WEBGL_compressed_texture_s3tc"),r!==null){if(i===Cr)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===Rr)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===Ir)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===Pr)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===Do||i===Lo||i===No||i===Uo)if(r=t.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(i===Do)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===Lo)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===No)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Uo)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Fo||i===Oo||i===Bo||i===zo||i===ko||i===Dr||i===Vo)if(r=t.get("WEBGL_compressed_texture_etc"),r!==null){if(i===Fo||i===Oo)return a===te?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(i===Bo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC;if(i===zo)return r.COMPRESSED_R11_EAC;if(i===ko)return r.COMPRESSED_SIGNED_R11_EAC;if(i===Dr)return r.COMPRESSED_RG11_EAC;if(i===Vo)return r.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Go||i===Ho||i===Wo||i===Xo||i===qo||i===Yo||i===Zo||i===$o||i===Jo||i===Ko||i===jo||i===Qo||i===tl||i===el)if(r=t.get("WEBGL_compressed_texture_astc"),r!==null){if(i===Go)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Ho)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Wo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Xo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===qo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Yo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Zo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===$o)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Jo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Ko)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===jo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Qo)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===tl)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===el)return a===te?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===nl||i===il||i===sl)if(r=t.get("EXT_texture_compression_bptc"),r!==null){if(i===nl)return a===te?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===il)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===sl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===rl||i===al||i===Lr||i===ol)if(r=t.get("EXT_texture_compression_rgtc"),r!==null){if(i===rl)return r.COMPRESSED_RED_RGTC1_EXT;if(i===al)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Lr)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===ol)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ls?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:e}}var eb=`
void main() {
