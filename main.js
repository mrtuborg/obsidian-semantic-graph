...
var SemanticGraphView = class extends import_obsidian.ItemView {
  ...
  render() {
    ...
    this.pendingRaf = requestAnimationFrame(() => {
      ...
      const edgeLine = g.append("g").selectAll("line").data(simEdges).join("line").attr("class", "llm-graph-edge").attr("stroke-width", 1.2).attr("stroke", (d) => {
